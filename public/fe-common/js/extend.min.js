define(function(require,exports,modules){require("ui-blocklist"),require("ui-pagination"),require("ui-selectgroup"),require("ui-logicblock"),require("ui-notice"),require("ui-htree")}),define("ui-pagination",function(require,exports,module){$.ae.lang.aePagination={firstPageTipText:"First",lastPageTipText:"Last",prePageTipText:"Prev",nextPageTipText:"Next",totalRecordsBeforeText:"Total"},$.aeWidget("ae.aePagination",{options:{initType:"html",totalRecords:0,pageSize:10,align:"right",currentPage:1,isShowPageSizeCombo:!0,isShowFirstLastBtn:!1,isShowPreNextBtn:!0,isShowTotalPage:!1,isShowCurrPage:!1,isShowTotalRecords:!1,isMinPagination:!1,onPageChange:$.noop,onComboChange:$.noop},_create:function(){var self=this,options=self.options,$ele=self.element,id=$ele.attr("id");id&&$ele.attr("aeId",id),"html"==options.initType&&($ele.addClass("wrapper clearfix"),self._buildOptions(options,$ele))},_buildOptions:function(ops,el){ops.aeType=el.attr("aeType")||"aePagination",ops.totalRecords=el.attr("totalRecords")||ops.totalRecords,ops.currentPage=el.attr("currentPage")||ops.currentPage,ops.pageSize=el.attr("pageSize")||ops.pageSize,ops.isShowPageSizeCombo=el.attr("isShowPageSizeCombo")||ops.isShowPageSizeCombo,ops.isShowFirstLastBtn=el.attr("isShowFirstLastBtn")||ops.isShowFirstLastBtn,ops.isShowPreNextBtn=el.attr("isShowPreNextBtn")||ops.isShowPreNextBtn,ops.isShowTotalPage=el.attr("isShowTotalPage")||ops.isShowTotalPage,ops.isShowCurrPage=el.attr("isShowCurrPage")||ops.isShowCurrPage,ops.isShowTotalRecords=el.attr("isShowTotalRecords")||ops.isShowTotalRecords,ops.isGoPage=el.attr("isGoPage")||ops.isGoPage,ops.onPageChange=el.attr("onPageChange")||ops.onPageChange,ops.align=el.attr("align")||ops.align},reload:function(ops){$.extend(!0,this.options,ops),this._generPageHtml(this.options)},_generPageHtml:function(ops){var i,key,self=this,i18n=$.ae.lang.aePagination;ops.currentPage=parseInt(ops.currentPage)||1;var totalPage=ops.totalRecords%ops.pageSize?Math.ceil(ops.totalRecords/ops.pageSize):ops.totalRecords/ops.pageSize;if(ops.totalPage=totalPage,!ops.totalPage)return self.element.empty(),!1;ops.prv=ops.currentPage<=2?1:ops.currentPage-1,ops.next=ops.currentPage>=ops.totalPage-1?ops.totalPage:ops.currentPage+1,ops.hasPrv=ops.currentPage>1,ops.hasNext=ops.currentPage<ops.totalPage;var str_first="",str_prv="",str_next="",str_last="";ops.isShowFirstLastBtn&&(str_first=ops.hasPrv?"<li><a "+this._getHandlerStr(1)+' title="'+i18n.firstPageTipText+'"><<</a></li>':'<li class="disabled"><a href="javascript:void(0)" title="'+i18n.firstPageTipText+'"><<</a></li>',str_last=ops.hasNext?"<li><a "+this._getHandlerStr(ops.totalPage)+' title="'+i18n.lastPageTipText+'">>></a></li>':'<li class="disabled" title="'+i18n.lastPageTipText+'"><a href="javascript:void(0)">>></a></li>'),ops.isShowPreNextBtn&&(str_prv=ops.hasPrv?"<li><a "+this._getHandlerStr(ops.prv)+' title="'+i18n.prePageTipText+'"><</a></li>':'<li class="disabled" title="'+i18n.prePageTipText+'"><a href="javascript:void(0)"><</a></li>',str_next=ops.hasNext?"<li><a "+this._getHandlerStr(ops.next)+' title="'+i18n.nextPageTipText+'">></a></li>':'<li class="disabled"><a href="javascript:void(0)" title="'+i18n.nextPageTipText+'">></a></li>');var str="",dot='<li class="dot"><a href="javascript:void(0)">...</a></li>';if(ops.isMinPagination)str='<li class="active"><a href="javascript:void(0)">'+ops.currentPage+"</a></li>";else if(ops.totalPage<=8)for(i=1;i<=ops.totalPage;i++)str+=ops.currentPage==i?'<li class="active"><a href="javascript:void(0)">'+i+"</a></li>":"<li><a "+this._getHandlerStr(i)+">"+i+"</a></li>";else if(ops.currentPage<=5){for(i=1;6>=i;i++)str+=ops.currentPage==i?'<li class="active"><a href="javascript:void(0)">'+i+"</a></li>":"<li><a "+this._getHandlerStr(i)+">"+i+"</a></li>";str+=dot,str+="<li><a "+this._getHandlerStr(ops.totalPage)+">"+ops.totalPage+"</a></li>"}else{str+="<li><a "+this._getHandlerStr(1)+">1</a></li>",str+=dot;var begin=ops.currentPage-2,end=ops.currentPage+2;for(end>ops.totalPage?(end=ops.totalPage,begin=end-4,ops.currentPage-begin<2&&(begin-=1)):end+1==ops.totalPage&&(end=ops.totalPage),i=begin;end>=i;i++)str+=ops.currentPage==i?'<li class="active"><a href="javascript:void(0)">'+i+"</a></li>":"<li><a "+this._getHandlerStr(i)+">"+i+"</a></li>";end!=ops.totalPage&&(str+=dot),end!=ops.totalPage&&(str+="<li><a "+this._getHandlerStr(ops.totalPage)+">"+ops.totalPage+"</a></li>")}var pagerHtml='<ul class="pagination m-n pull-right">';pagerHtml+=str_first+str_prv+str+str_next+str_last,pagerHtml+="</ul>";var flag,id,changeName,html="";ops.isShowPageSizeCombo&&(flag=!0,id=this.element.attr("id")+"_PageSize",changeName=id.replace(/-/g,"_"),html="function"==typeof ops.onComboChange?'<div class="pull-left m-r-sm"><span onValueChange="'+changeName+'" aeType="aeCombo" id="'+id+'" aeInit="true"width="100"></span></div>':'<div class="pull-left m-r-sm"><span aeType="aeCombo" id="'+id+'" aeInit="true"width="100"></span></div>');var total_info="";if(ops.isShowTotalRecords&&(total_info+='<div class="pull-left m-n text-light" style="line-height:32px;">'+i18n.totalRecordsBeforeText+":"+ops.totalRecords+"</div>"),html+=total_info,html+=pagerHtml,this.element.addClass("text-"+ops.align).html(html),flag){var comboFlag,data=[{text:"5 Items",value:"5"},{text:"10 Items",value:"10"},{text:"15 Items",value:"15"}];for(key in data)if(data[key].value==ops.pageSize){comboFlag=!0;break}comboFlag||data.unshift({text:ops.pageSize+" Items",value:ops.pageSize}),"function"==typeof ops.onComboChange&&(window[changeName]=function(){var pageSize=$("#"+id).aeCombo("getValue");self.options.pageSize=pageSize,self.options.currentPage="1",ops.onComboChange.call(self,self.options.currentPage,pageSize),self.setTotalRecords(self.options.totalRecords)}),$("#"+id).aeCombo("reload",data),$("#"+id).aeCombo("setDefault",ops.pageSize)}this.element.find("li:not(.disabled,.active,.dot)").on("click",function(){self.selectPage($(this).children().attr("data-value")),self.options.onPageChange.call(self,$(this).children().attr("data-value"),ops.pageSize)})},_getHandlerStr:function(n){return'href="javascript:void(0)" data-value='+n},selectPage:function(pageNumber){this.options.currentPage=pageNumber},setTotalRecords:function(totalRecords){this.options.totalRecords=totalRecords,this._generPageHtml(this.options)},getPageSize:function(){return this.options.pageSize}})}),define("ui-blocklist",function(require,exports,moudles){function getDataSegment(data,pageNumber,pageSize){var count,start;return $.isArray(data)?(count=data.length,start=(pageNumber-1)*pageSize,data.slice(start,start+pageSize)):null}$.aeWidget("ae.aeBlocklist",{options:{mutiSelect:!1,col:"1",columnHeadId:"",pagingConfig:{},selectedRowStyle:"",traceRowStyle:"",showEmpty:!1,showException:!1,emptyTipMsg:"data",tpl:"",template:null,localPagination:!1},_create:function(){var options=this.options,$ele=this.element,id=$ele.attr("id");id&&$ele.attr("aeId",id),$ele.attr("aeInit",!1),this._source=null,this._buildOptions(options,$ele),this._rebuildSkeleton(),this._loadColumnHead(),this._createEmptyBrand()},_hdLocalPageChange:function(currentPageNumber,pageSize){var opts,pn=parseInt(currentPageNumber,10),finalData=getDataSegment(this._source,pn,parseInt(pageSize,10)),$el=$("#"+this.options.pagingConfig.id);this.clear(),opts=$el.aePagination("option"),opts.currentPage=pn,$el.aePagination("reload",opts),this._reload(finalData,this.options)},_loadColumnHead:function(){var $el,$cntr,options=this.options;options.columnHeadId&&($el=$("#"+options.columnHeadId),$el.length>0&&($cntr=this.element.find("[data-role='column-head-container']"),0===$cntr.children().length&&$cntr.append($el)))},_createExceptionBrand:function(){var $emptyHtml,$ele=this.element;0===$ele.find("[data-role='exceptionBrand']").length&&($emptyHtml=$('<div data-role="exceptionBrand" style="display: none;width:100%" class="text-center padder-v-lg m-t-xl m-b-lg bg-white text-muted"> <i class="md-warning icon-xl"></i><p class="text-md">Data error.</p></div>'),$emptyHtml.appendTo($ele))},_showExceptionBrand:function(){this.options.showException&&this.element.find("[data-role='exceptionBrand']").fadeIn()},_hideExceptionBrand:function(){this.element.find("[data-role='exceptionBrand']").stop().hide()},_reload:function(data){var dataArray=(this.element,this.options,data);return this._hideExceptionBrand(),this._hideEmptyBrand(),this._rebuildSkeleton(),this._loadColumnHead(),dataArray?$.isArray(dataArray)?this._generator(dataArray):(this._createExceptionBrand(),this._showExceptionBrand(),!1):(this._createEmptyBrand(),this._showEmptyBrand(),!1)},_reloadPagination:function(paginationOptions){var hdChange,opts=$.extend({},paginationOptions);this.options.localPagination===!0&&(hdChange=$.proxy(this._hdLocalPageChange,this),opts.onPageChange=hdChange,opts.onComboChange=hdChange),0===$("#"+paginationOptions.id).length&&this.element.after('<div style="clear:both"></div><div id="'+paginationOptions.id+'" aeType="aePagination" aeInit="true"></div>'),$("#"+paginationOptions.id).aePagination("reload",opts)},_rebuildSkeleton:function(){var $ele=this.element;this.options.columnHeadId?0===$ele.find(".block-list-tb").length&&this.element.empty().append($("<div class='block-list-tb'><div data-role='column-head-container' class='list-head'></div><div data-role='body-container' class='list-body'></div></div>")):0===$ele.find(".block-list").length&&this.element.empty().append($("<div class='block-list'><div data-role='column-head-container'></div><div data-role='body-container'></div></div>"))},reload:function(data){var $el,finalData=data?data.data:null;$.extend(!0,this.options,data),this.clear(),this._buildOptions(this.options,this.element),this._hidePagination(),this.hasPaging()===!0&&data&&$.isArray(data.data)&&data.data.length>0&&(this._reloadPagination(this.options.pagingConfig),this._showPagination(),this.options.localPagination===!0&&(this._source=data.data,$el=$("#"+this.options.pagingConfig.id),finalData=getDataSegment(this._source,$el.aePagination("option","currentPage"),$el.aePagination("getPageSize")))),this._reload(finalData,this.options)===!0&&this._addEvents()},_showPagination:function(){var $page=$("#"+this.options.pagingConfig.id);$page.length>0&&$page.show()},_hidePagination:function(){var $page=$("#"+this.options.pagingConfig.id);$page.length>0&&$page.hide()},_setRowSelectedStyle:function(chk,isChecked){var opts=this.options;isChecked?$(chk.parentNode.parentNode).addClass(opts.selectedRowStyle):$(chk.parentNode.parentNode).removeClass(opts.selectedRowStyle)},_addEvents:function(){var opts=this.options,self=this;opts.selectedRowStyle&&this.element.off("click").on("click","[data-role='_checkbox']",function(event){self._setRowSelectedStyle(this,this.checked)}),opts.traceRowStyle&&this.element.find(".list-item").on("mouseover",function(event){var $this=$(this),$chk=$this.find("[data-role='_checkbox']");opts.selectedRowStyle&&$chk.length>0&&$chk[0].checked&&$this.removeClass(opts.selectedRowStyle),$this.addClass(opts.traceRowStyle)}).on("mouseout",function(event){var $this=$(this),$chk=$this.find("[data-role='_checkbox']");$this.removeClass(opts.traceRowStyle),opts.selectedRowStyle&&$chk.length>0&&$chk[0].checked&&$this.addClass(opts.selectedRowStyle)})},clear:function(){this.element.find("[data-role='body-container']").empty(),this._showEmptyBrand()},selectAll:function(){var $chks,i,count;if(this.options.mutiSelect)for($chks=this.element.find("[data-role='_checkbox']"),count=$chks.length,i=0;count>i;i++)$chks[i].checked===!1&&($chks[i].checked=!0,this._setRowSelectedStyle($chks[i],!0))},getSelected:function(){var $els,$item,i,data=[];if(this.options.mutiSelect)for($els=this.element.find("[data-role='_checkbox']"),i=0;i<$els.length;i++)$els[i].checked&&($item=$($els[i].parentNode.parentNode),data.push($item.data()));else data.push($item.data());return data},hasPaging:function(){var pagingConfig=this.options.pagingConfig;return!(!pagingConfig||!pagingConfig.id)},addBlock:function(blockData,tmpl,pos){var i,count,template,resultHtmlObj,$ele=this.element.find("[data-role='body-container']").eq(0),arrayData=[];if($.isArray(blockData)?arrayData=blockData:$.isObject(blockData)&&arrayData.push(blockData),this.hasPaging()===!1){if(this._hideExceptionBrand(),this._hideEmptyBrand(),tmpl&&(template=Handlebars.compile("<div class='list-item'>"+tmpl+"</div>")),resultHtmlObj=this._generatorDOMs(arrayData,template),count=resultHtmlObj.length,pos&&"top"===pos)for(i=0;count>i;i++)resultHtmlObj[i].prependTo($ele);else for(i=0;count>i;i++)resultHtmlObj[i].appendTo($ele);return $.aries.common.globalInit(this.element.attr("id")),1===resultHtmlObj.length?resultHtmlObj[0]:resultHtmlObj}return null},setData:function(data){var $pagination,opts,$el,finalData=data;this.clear(),this._hidePagination(),this.hasPaging()===!0&&data.length>0&&($pagination=$("#"+this.options.pagingConfig.id),opts=$pagination.length>0?$pagination.aePagination("option"):this.options.pagingConfig,this._reloadPagination(opts),this._showPagination(),this.options.localPagination===!0&&(this._source=data,$el=$("#"+this.options.pagingConfig.id),finalData=getDataSegment(this._source,$el.aePagination("option","currentPage"),$el.aePagination("getPageSize")))),this._reload(finalData,this.options)===!0&&this._addEvents()},_buildOptions:function(options,element){var tmplStr;options.aeType=element.attr("aeType")||"aeBlocklist",options.col=options.col||element.attr("col"),options.selectedRowStyle=options.selectedRowStyle||element.attr("selectedRowStyle"),options.showEmpty=options.showEmpty||element.attr("showEmpty"),options.showEmpty="false"===options.showEmpty?!1:!!options.showEmpty,options.showException=options.showException||element.attr("showException"),options.showException="false"===options.showException?!1:!!options.showException,options.emptyTipMsg=element.attr("emptyTipMsg")?element.attr("emptyTipMsg"):"data",options.mutiSelect=options.mutiSelect||element.attr("mutiSelect"),options.mutiSelect="false"===options.mutiSelect?!1:!!options.mutiSelect,tmplStr=options.mutiSelect?"<div class='list-item' style='display: none;position:relative;padding-left:22px'><div style='position:absolute;margin-left:5px;left:0;top:50%;margin-top:-12px'><input type='checkbox' data-role='_checkbox' style='cursor:pointer'/></div>"+options.tpl+"</div>":"<div class='list-item' style='display: none'>"+options.tpl+"</div>",options.template=Handlebars.compile(tmplStr),options.columnHeadId=options.columnHeadId||element.attr("columnHeadId")||""},_generator:function(data){this.options;return $.isArray(data)&&0===data.length?(this._showEmptyBrand(),!1):(this._hideEmptyBrand(),this._generatorHtml(data),$.aries.common.globalInit(this.element.attr("id")),!0)},_generatorHtml:function(srcArr){var i,count,$ele=this.element.find("[data-role='body-container']"),resultHtmlObj=(this.options,this._generatorDOMs(srcArr));for(i=0,count=resultHtmlObj.length;count>i;i++)resultHtmlObj[i].appendTo($ele).fadeIn()},_createEmptyBrand:function(){var $emptyHtml,$ele=this.element,options=this.options;0===$ele.find("[data-role='emptyBrand']").length&&($emptyHtml=$('<div style="display: none;width:100%" data-role="emptyBrand" class="text-center padder-v-lg m-t-xl m-b-lg bg-white text-muted"> <i class="md-error icon-xl"></i><p class="text-md">No '+options.emptyTipMsg+".</p></div>"),$emptyHtml.appendTo($ele))},_showEmptyBrand:function(){this.options.showEmpty&&this.element.find("[data-role='emptyBrand']").fadeIn()},_hideEmptyBrand:function(){this.element.find("[data-role='emptyBrand']").stop().hide()},_generatorDOMs:function(data,tpl){var $item,rowStr,$row,i,options=this.options,template=tpl||options.template,col=options.col,itemStr="",doms=[],count=data.length;if("1"==col)for(i=0;count>i;i++)itemStr=template(data[i]),$item=$(itemStr),$item.data(data[i]),doms.push($item);else for(rowStr="<div class='list-row'></div>",$row=$(rowStr),i=0;count>i;i++)itemStr=template(data[i]),$item=$(itemStr),$item.data(data[i]),$item.appendTo($row),(i+1)%col||i+1===data.length||(doms.push($row),$row=$(rowStr));return doms}})}),define("ui-selectgroup",function(require,exports,moudles){$.aeWidget("ae.aeSelectgroup",{options:{initType:"html",mode:"simple"},_create:function(){var self=this,options=self.options,$ele=self.element,id=$ele.attr("id");id&&$ele.attr("aeId",id),"html"==options.initType&&(options.mode=$ele.attr("mode")||options.mode,options.aeType=$ele.attr("aeType")||"aeSelectgroup")},_init:function(){var self=this,options=self.options,el=self.element;"complex"===options.mode?el.addClass("btn-group select-group select-group-complex"):el.addClass("btn-group select-group select-group-simple");var labelArr=el.find(">button");labelArr.each(function(index,item){if($(item).addClass("btn btn-default"),0===$(item).find("input").next().length){var html=$(item).html(),array=html.split(">");array[1]="<span>"+array[1]+"</span>",$(item).html(array.join(">"))}}),el.show();var type=self.type();!function(){el.on("click","button.btn",function(e){var checked=$(this).find("input").is(":checked");"radio"===type?checked||($(this).siblings(".btn-primary").removeClass("btn-primary").addClass("btn-default").find("i.fa-check-circle-o").remove(),$(this).addClass("btn-primary").removeClass("btn-default"),"complex"===options.mode&&$(this).append('<i class="fa fa-check-circle-o"></i>'),$(this).find("input").attr("checked",!0)):checked?($(this).removeClass("btn-primary").addClass("btn-default").find("i.fa-check-circle-o").remove(),$(this).find("input").removeAttr("checked")):($(this).addClass("btn-primary").removeClass("btn-default"),"complex"===options.mode&&$(this).append('<i class="fa fa-check-circle-o"></i>'),$(this).find("input").prop("checked","checked"))})}()},type:function(){return this.element.find(".btn input").eq(0).attr("type")||"radio"},getSelectValue:function(){var self=this,el=(self.options,self.element);if("radio"===this.type())return el.find("input[type='radio']:checked").val();var checkedArr=[];return el.find("input[type='checkbox']").each(function(index,item){$(this).prop("checked")&&checkedArr.push($(this).val())}),checkedArr},getSelectText:function(){var self=this,el=(self.options,self.element);if("radio"===this.type())return el.find("input[type='radio']:checked").next().text();var checkedArr=[];return el.find("input[type='checkbox']").each(function(index,item){$(item).prop("checked")&&checkedArr.push($(item).next().text())}),checkedArr},setSelectByIndex:function(obj){var selectObj,self=this,options=self.options,el=self.element,type=this.type();if(isNaN(obj)){if("[object Array]"==Object.prototype.toString.call(obj)){if("radio"===type)return!1;for(var i=0;i<obj.length;i++)selectObj=el.find(".btn").eq(parseInt(obj[i])),selectObj.hasClass("btn-primary")||(selectObj.addClass("btn-primary").removeClass("btn-default"),"complex"===options.mode&&selectObj.append('<i class="fa fa-check-circle-o"></i>'),el.find("input").eq(parseInt(obj[i])).prop("checked","checked"))}}else if("radio"===type)el.find(".btn-primary").removeClass("btn-primary").addClass("btn-default").find("i.fa-check-circle-o").remove(),selectObj=el.children().eq(parseInt(obj)),selectObj.addClass("btn-primary").removeClass("btn-default"),"complex"===options.mode&&selectObj.append('<i class="fa fa-check-circle-o"></i>'),el.find("input[type='radio']").eq(parseInt(obj)).attr("checked",!0);else if("checkbox"===type){if(selectObj=el.find(".btn").eq(parseInt(obj)),selectObj.hasClass("btn-primary"))return!1;selectObj.addClass("btn-primary").removeClass("btn-default"),"complex"===options.mode&&selectObj.append('<i class="fa fa-check-circle-o"></i>'),selectObj.find("input").prop("checked","checked")}},setSelectByValue:function(obj){var selectObj,self=this,options=self.options,el=self.element,type=this.type();if(isNaN(obj)){if("[object Array]"==Object.prototype.toString.call(obj)){if("radio"===type)return!1;for(var i=0;i<obj.length;i++){if(selectObj=el.find("input[value='"+obj[i]+"']"),selectObj.hasClass("btn-primary"))return!1;selectObj.prop("checked","checked").parent().addClass("btn-primary").removeClass("btn-default"),"complex"===options.mode&&selectObj.parent().append('<i class="fa fa-check-circle-o"></i>')}}}else if("radio"===type)el.find(".btn-primary").removeClass("btn-primary").addClass("btn-default").find("i.fa-check-circle-o").remove(),selectObj=el.find("input[value='"+obj+"']:radio").attr("checked",!0).parent().addClass("btn-primary").removeClass("btn-default"),"complex"===options.mode&&selectObj.parent().append('<i class="fa fa-check-circle-o"></i>');else if("checkbox"===type){if(selectObj=el.find("input[value='"+obj+"']"),selectObj.hasClass("btn-primary"))return!1;selectObj.prop("checked","checked").parent().addClass("btn-primary").removeClass("btn-default"),"complex"===options.mode&&selectObj.parent().append('<i class="fa fa-check-circle-o"></i>')}},empty:function(){var self=this,el=(self.options,self.element);return el.find(".btn-primary").removeClass("btn-primary").addClass("btn-default"),"radio"===this.type()?el.find("input[type='radio']:checked").removeAttr("checked"):(el.find("input[type='checkbox']").each(function(index,item){$(this).prop("checked")&&($(this).removeAttr("checked"),$(this).parent().find("i.fa-check-circle-o").remove())}),!1)}})}),define("ui-logicblock",function(require,exports,moudles){function getSearchbarString(){var i18n=$.ae.lang.aeLogicBlock,s='<div class="node-selection-search"><i class="close_circle pull-right none" data-role="search-clear" style="cusor:pointer"></i><i class="search"></i><input type="text" class="node-search-input" data-role="search-input"/></div><ul class="none" data-role="result" style="padding:50px 10px 0 10px;width:100%"><div data-role="not-found" style="width:100%" class="none text-center padder-v-lg m-t-xl m-b-lg bg-white text-muted"><i class="md-info-outline text-muted" style="width:70px;height:70px"></i><p class="text-md text-muted">'+i18n.notFound+"</p></div></ul>";return s}function getResultItemString(nodeId,nodeInfo){var s="<li data-node-id='"+nodeInfo.id+"'><i class='icon-page2' style='font-size:24px;color:rgb(204,204,204)'></i><div style='display:inline-block;padding:5px'>";return s+="<span title='"+nodeInfo.name+"'>"+nodeInfo.name+"</span>",s+="</div></li>"}function getId(prefix){return prefix+(new Date).getTime()}function defaultTemplateParser(attr,val,tmplStr){var s;return s=tmplStr.replace(/\$ATTR_CODE\$/g,attr),s=s.replace(/\$ATTR_VALUE\$/g,val)}function getOperator(operators,operatorName){var i;for(i=operators.length-1;i>=0;i--)if(operators[i].name===operatorName)return operators[i];return null}function Expression(exprId,rootGroupId,defaultOperatorText,defaultOperatorCode){this.id=exprId,this.root=new MemberGroup({id:rootGroupId||!1,expr:this,operator:defaultOperatorCode,operatorName:defaultOperatorText}),this.groups={},this.groups[this.root.id]=this.root}function Member(id,variableName,variable,variableId,operator,operatorName,value,valueText,valueType,controlType,template,displayTemplate,parentGroup){this.id=id,this.variableName=variableName,this.variable=variable,this.variableId=variableId,this.operator=operator,this.operatorName=operatorName,this.value=value,this.valueText=valueText,this.valueType=valueType||VALUE_TYPE_STR,this.controlType=controlType||null,this.template=template,this.displayTemplate=displayTemplate,this.parentGroup=parentGroup||null}function MemberGroup(options){this.expr=options.expr,this.operator=options.operator||"and",this.operatorName=options.operatorName||"AND",this.members=options.members||[],this.id=options.id||getId("g"),this.parentGroup=options.parentGroup||null}function getCondition(memberId,valueType){var $variable,variableInfo,mapVars,$operator,operatorInfo,controlType,$enum,v,idx,obj,$el=$("#"+memberId),groupId=$el.attr("data-group-id"),opts=getOptions(groupId),vt="";return $operator=$el.find("[data-role='member-operator']"),controlType=parseInt($operator.aeCombo("getUserdata",$operator.aeCombo("getIndex")).controlType,10),controlType==CTRL_ENUM?($enum=$el.find("[data-role='member-value-enum']"),v=$enum.aeCombo("getValue"),vt=$enum.aeCombo("getDisplayText")):controlType==CTRL_TEXT?(v=$el.find("[data-role='member-value']").val(),vt=v):controlType==CTRL_NUM?(v=$el.find("[data-role='member-value-number']").aeFlip("getValue"),vt=v):controlType==CTRL_DATE?3===valueType?(v=$el.find("[data-role='member-value-date']").aeCalendar("getValue"),vt=v):4===valueType&&(v=$el.find("[data-role='member-value-datetime']").aeCalendar("getValue"),vt=v):(v="?",vt="?"),obj={valueType:valueType,operator:$operator.aeCombo("getValue"),operatorName:$operator.aeCombo("getDisplayText"),controlType:controlType,value:v||"?",valueText:vt||"?"},opts.hasCatalog?($variable=$el.find("[data-role='member-tree-button']"),obj.variable=$variable.attr("data-code"),mapVars=getMapVars(groupId),variableInfo=mapVars[$variable.attr("data-variable-id")],obj.variableName=variableInfo.name,obj.variableId=variableInfo.id,operatorInfo=getOperator(variableInfo.operators,obj.operatorName),obj.template=operatorInfo.template||"",obj.displayTemplate=operatorInfo.displayTemplate||""):($variable=$el.find("[data-role='member-variable']"),obj.variable=$variable.aeCombo("getValue"),idx=$variable.aeCombo("getIndex"),variableInfo=$variable.aeCombo("getUserdata",idx),obj.variableName=$variable.aeCombo("getDisplayText"),obj.variableId=variableInfo.id,operatorInfo=getOperator(variableInfo.operators,obj.operatorName),obj.template=operatorInfo.template||"",obj.displayTemplate=operatorInfo.displayTemplate||""),obj}function createMemberGroupView(groupId){var s;return groupId=groupId||getId("gid"),s=tmplGroup.replace(/\{\{id\}\}/g,groupId),$(s)}function createMemberView(groupId,memberId){var s;return memberId=memberId||getId("mid"),s=tmplMember.replace(/\{\{id\}\}/g,memberId),s=s.replace(/\{\{group_id\}\}/g,groupId),$(s)}function createVariableTreeButtonView(groupId,memberId,data){var firstVariableId=data[0].variableId,$el=$("<button class='btn btn-default m-b-xs' data-role='member-tree-button' data-variable-id='"+firstVariableId+"' data-group-id='"+groupId+"' data-member-id='"+memberId+"'></button>");return $el}function createVariableTreeDialogView(exprId,data){var id="logicblock-"+exprId,$el=$("#"+id),s=getSearchbarString();return 0===$el.length&&($el=$("<div aeType='aeDialog' id='"+id+"' data-role='member-tree-dialog' style='display:none'>"+s+"<div style='padding-top:40px;height:100%' data-role='var-tree'><div style='overflow:auto;height:100%'><div aeType='aeTree' showCheckbox='false' showLine='true' idField='id' pIdField='pid' labelField='name' valueField='id' data-role='member-tree' onSelect='hdVariablesTreeSelect'></div></div></div></div>"),$(document.body).append($el)),$el}function createVariableView(groupId,memberId,data,selectedValue){var $el=$("<span aeType='aeCombo' id='var_"+memberId+"' aeInit='false' class='none' width='150px' optionField='name' valueField='id' data-role='member-variable' data-group-id='"+groupId+"' data-member-id='"+memberId+"'>");return $el}function createOperatorView(groupId,memberId,data,selectedValue){var $el=$("<span aeType='aeCombo' id='opr_"+memberId+"' class='none' width='160px' optionField='name' valueField='code' data-role='member-operator' data-value-type='"+data.valueType+"' data-group-id='"+groupId+"' data-member-id='"+memberId+"'>");return $el}function hdDateChange(target){var $el=target.parent().prev(),groupId=$el.attr("data-group-id"),memberId=$el.attr("data-member-id"),valueType=$el.attr("data-value-type"),obj={groupId:groupId,memberId:memberId,valueType:parseInt(valueType,10)};updateExpression(obj)}function createValueView($cntr,groupId,memberId,valueType,val,defaultValue){var $els,$el,$elFlip,opt,s="<span aeType='aeCombo' id='enum_"+memberId+"' aeInit='false' class='none' width='150px' optionField='name' valueField='code' data-role='member-value-enum' data-value-type='"+valueType+"' data-group-id='"+groupId+"' data-member-id='"+memberId+"'/><input type='text' class='form-control' data-role='member-value' data-value-type='"+valueType+"' data-group-id='"+groupId+"' data-member-id='"+memberId+"' style='width:150px'/><span aeType='aeCalendar' width='150px' data-role='member-value-date' data-value-type='"+valueType+"' data-group-id='"+groupId+"' data-member-id='"+memberId+"' onValueChange='hdDateChange'></span><span aeType='aeCalendar' width='150px' data-role='member-value-datetime' data-value-type='"+valueType+"' data-group-id='"+groupId+"' data-member-id='"+memberId+"' onValueChange='hdDateChange'></span><span aeType='aeFlip' data-role='member-value-number' width='150px' minData='0' data-value-type='"+valueType+"' data-group-id='"+groupId+"' data-member-id='"+memberId+"'></span>";return $els=$(s),$cntr.append($els),$el=$cntr.find("[data-role='member-value-enum']"),$el.aeCombo({visible:!1}),$el.next().addClass("m-b-xs"),$cntr.find("[data-role='member-value-date']").aeCalendar({showTime:!1,visible:!1}),$cntr.find("[data-role='member-value-datetime']").aeCalendar({showTime:!0,visible:!1}),$elFlip=$cntr.find("[data-role='member-value-number']"),$elFlip.aeFlip({visible:!1}),$elFlip.next().addClass("m-b-xs"),opt=$elFlip.aeFlip("option"),opt.onValueChange=hdDateChange,$els.hide(),$.isArray(val)?($el=$($els[0]),$el.aeCombo("visible",!0),$el.next().addClass("m-b-xs")):2==valueType?($el=$cntr.find("[data-role='member-value-number']"),$el.aeFlip("visible",!0),$el.aeFlip("setValue",val||defaultValue||"")):3==valueType?($el=$cntr.find("[data-role='member-value-date']"),$el.aeCalendar("visible",!0),$el.next().addClass("m-b-xs"),$el.aeCalendar("setValue",val||defaultValue||"")):4==valueType?($el=$cntr.find("[data-role='member-value-datetime']"),$el.aeCalendar("visible",!0),$el.next().addClass("m-b-xs"),$el.aeCalendar("setValue",val||defaultValue||"")):($el=$($els[1]),$el.addClass("m-b-xs"),$el.val(val||defaultValue||""),$el.show()),$elFlip.aeFlip("option",opt),$els}function updateExpressionWithCalendar($member){var groupId,condi,member,exprId,memberId=$member.attr("id");groupId=$member.attr("data-group-id"),member=ExpressionHelper.getGroup(groupId).getMember(memberId),condi=getCondition(memberId,3),member.value=condi.value,member.valueText=condi.valueText,member.valueType=condi.valueType,member.operator=condi.operator,member.operatorName=condi.operatorName,member.controlType=condi.controlType,member.variable=condi.variable,member.variableId=condi.variableId,member.variableName=condi.variableName,member.template=condi.template,member.displayTemplate=condi.displayTemplate,exprId=$("#"+groupId).attr("data-expr-id"),ExpressionHelper.fireExprChangeEvent(exprId)}function updateExpression(ownerInfo){var memberId,groupId,condi,member,valueType,exprId;$input?(groupId=$input.attr("data-group-id"),memberId=$input.attr("data-member-id"),valueType=parseInt($input.attr("data-value-type"),10)):(groupId=ownerInfo.groupId,memberId=ownerInfo.memberId,valueType=ownerInfo.valueType),member=ExpressionHelper.getGroup(groupId).getMember(memberId),condi=getCondition(memberId,valueType),member.value=condi.value,member.valueText=condi.valueText,member.valueType=condi.valueType,member.operator=condi.operator,member.operatorName=condi.operatorName,member.controlType=condi.controlType,member.variable=condi.variable,member.variableId=condi.variableId,member.variableName=condi.variableName,member.template=condi.template,member.displayTemplate=condi.displayTemplate,$input=null,hdTimer=null,exprId=$("#"+groupId).attr("data-expr-id"),ExpressionHelper.fireExprChangeEvent(exprId)}function getMapVars(groupId){var exprId=$("#"+groupId).attr("data-expr-id"),$el=$('[data-expr-inst-id="'+exprId+'"]'),mapVars=$el.data("map_vars");return mapVars}function getOptions(groupId){var exprId=$("#"+groupId).attr("data-expr-id"),$el=$('[data-expr-inst-id="'+exprId+'"]'),option=$el.aeLogicBlock("option");return option}function refreshOperators(ownerInfo,variablesData,defaultValue){var memberId=ownerInfo.memberId,$member=$("#"+memberId),$elOpers=$member.find("[data-role='member-operator']");
$elOpers.aeCombo("reload",variablesData.operators),$elOpers.aeCombo("setDefault",defaultValue||variablesData.operators[0].code),setOperatorsUserdata($elOpers,variablesData.operators),_operatorChange($elOpers)}function updateValuesModel(ownerInfo){var memberId=ownerInfo.memberId,$member=$("#"+memberId),controlType=ownerInfo.controlType,valueType=ownerInfo.valueType;controlType==CTRL_NUM?updateExpression(ownerInfo):controlType==CTRL_TEXT?updateExpression(ownerInfo):controlType==CTRL_DATE?valueType==VALUE_TYPE_DATE?updateExpressionWithCalendar($member):valueType==VALUE_TYPE_DATETIME&&updateExpressionWithCalendar($member):updateExpression(controlType==CTRL_ENUM?ownerInfo:ownerInfo)}function refreshValues(ownerInfo,optionValue,defaultValue){var finalValue,memberId=ownerInfo.memberId,$member=$("#"+memberId),$elEnum=(ownerInfo.groupId,$member.find("[data-role='member-value-enum']")),$elValue=$member.find("[data-role='member-value']"),$elDate=$member.find("[data-role='member-value-date']"),$elDateTime=$member.find("[data-role='member-value-datetime']"),$elNumberValue=$member.find("[data-role='member-value-number']"),valueType=ownerInfo.valueType,controlType=ownerInfo.controlType;$elValue.hide(),$elEnum.aeCombo("visible",!1),$elDate.aeCalendar("visible",!1),$elDateTime.aeCalendar("visible",!1),$elNumberValue.aeFlip("visible",!1),"?"===defaultValue&&(defaultValue=""),finalValue=optionValue||defaultValue,controlType==CTRL_NUM?($.isArray(finalValue)&&(finalValue=""),$elNumberValue.aeFlip("setValue",finalValue),$elNumberValue.aeFlip("visible",!0)):controlType==CTRL_TEXT?($.isArray(finalValue)&&(finalValue=""),$elValue.val(finalValue),$elValue.show()):controlType==CTRL_DATE?($.isArray(finalValue)&&(finalValue=""),valueType==VALUE_TYPE_DATE?($elDate.aeCalendar("setValue",finalValue),$elDate.aeCalendar("visible",!0)):valueType==VALUE_TYPE_DATETIME&&($elDateTime.aeCalendar("setValue",finalValue),$elDateTime.aeCalendar("visible",!0))):controlType==CTRL_ENUM&&($.isArray(finalValue)&&($elEnum.aeCombo("reload",finalValue),$elEnum.aeCombo("setDefault",finalValue[0].code)),$elEnum.aeCombo("visible",!0))}function refreshMemberView(nodeData){var memberId=window.logicblock_share_data.memberId,groupId=window.logicblock_share_data.groupId,$member=$("#"+memberId),$btn=($("#"+groupId),$member.find("[data-role='member-tree-button']"));delete window.logicblock_share_data,$btn.attr("data-code",nodeData.code).attr("data-variable-id",nodeData.id).text(nodeData.name),$member.find("[data-role='member-operator']").attr("data-value-type",nodeData.valueType),$member.find("[data-role='member-value']").attr("data-value-type",nodeData.valueType),$member.find("[data-role='member-value-enum']").attr("data-value-type",nodeData.valueType),$member.find("[data-role='member-value-date']").attr("data-value-type",nodeData.valueType).attr("data-group-id",groupId).attr("data-member-id",memberId),$member.find("[data-role='member-value-datetime']").attr("data-value-type",nodeData.valueType).attr("data-group-id",groupId).attr("data-member-id",memberId),$member.find("[data-role='member-value-number']").attr("data-value-type",nodeData.valueType).attr("data-group-id",groupId).attr("data-member-id",memberId),refreshOperators({groupId:groupId,memberId:memberId},nodeData)}function hdVariablesTreeSelect(nodeData){void 0!==nodeData.valueType&&($.closePopupDiv(),refreshMemberView(nodeData))}function hdTreeButtonClick(event){var groupId=$(this).attr("data-group-id"),memberId=$(this).attr("data-member-id"),exprId=(getOptions(groupId),$("#"+groupId).attr("data-expr-id")),dialogId="logicblock-"+exprId;$("#"+dialogId).find("[data-role='member-tree']");window.logicblock_share_data={groupId:groupId,memberId:memberId},$('[data-expr-inst-id="'+exprId+'"]').data("ae-aeLogicBlock")._initSearchbar(),$.openPopupDiv(dialogId,"Select Variable","640","480",{showButton:!1}),$("#"+dialogId).aeDialog("option","beforeClose",function(){$('[data-expr-inst-id="'+exprId+'"]').data("ae-aeLogicBlock")._resetDialog()})}function getFirstVariableObject(variables){var i,count=variables.length;for(i=0;count>i;i++)if("number"==typeof variables[i].valueType&&isNaN(variables[i].valueType)===!1)return variables[i];return null}function hdDelGroup(event){var groupId=$(this).attr("data-group-id");ExpressionHelper.delGroup(groupId),$("#"+groupId).fadeOut(400,function(){var $this=$(this);$this.remove(),exprId=$this.attr("data-expr-id"),ExpressionHelper.fireExprChangeEvent(exprId)})}function getValidVariables(variables){var i,count,arr=[];if($.isArray(variables))for(count=variables.length,i=0;count>i;i++)"number"==typeof variables[i].valueType&&isNaN(variables[i].valueType)===!1&&arr.push(variables[i]);return arr}function setVariablesUserData($el,variables){var i,count,idxs,datas,j=0;if($.isArray(variables)){for(count=variables.length,idxs=[],datas=[],i=0;count>i;i++)"number"==typeof variables[i].valueType&&isNaN(variables[i].valueType)===!1&&(idxs.push(j++),datas.push(variables[i]));$el.aeCombo("setUserdata",idxs,datas)}}function setOperatorsUserdata($el,operators){var i,count,idxs,datas;if($.isArray(operators)){for(count=operators.length,idxs=[],datas=[],i=0;count>i;i++)idxs.push(i),datas.push(operators[i]);$el.aeCombo("setUserdata",idxs,datas)}}function hdAddMember(event){var $memberView,$cntr,$select,condi,operators,$btn,variableObject,member,tmpl,tmplDisplay,defaultValue,$this=$(this),memberId=getId("mid"),groupId=$this.parent().attr("data-group-id"),exprId=$("#"+groupId).attr("data-expr-id"),$el=$('[data-expr-inst-id="'+exprId+'"]'),expr=$el.data("expr"),option=$el.aeLogicBlock("option");$memberView=createMemberView(groupId,memberId),$memberView.insertBefore($this),$cntr=$memberView.find("[data-role='member-cntr']"),option.hasCatalog?(variableObject=getFirstVariableObject(option.variables),null!==variableObject&&($btn=createVariableTreeButtonView(groupId,memberId,option.variables),$btn.attr("data-code",variableObject.code).attr("data-variable-id",variableObject.id).text(variableObject.name),$cntr.append($btn),$btn.on("click.aeLogicBlock",hdTreeButtonClick))):($select=createVariableView(groupId,memberId,option.variables),$cntr.append($select),$select.aeCombo({}),$select.next().addClass("m-b-xs"),$select.aeCombo("reload",getValidVariables(option.variables)),setVariablesUserData($select,option.variables),variableObject=$select.aeCombo("getUserdata",0),$select.aeCombo("setDefault",variableObject.id)),operators=variableObject.operators,tmpl=operators[0].template,tmplDisplay=operators[0].displayTemplate,defaultValue=operators[0].defaultValue,$select=createOperatorView(groupId,memberId,variableObject),$cntr.append($select),$select.aeCombo({}),$select.next().addClass("m-b-xs"),$select.aeCombo("reload",operators),$select.aeCombo("setDefault",operators[0].code),setOperatorsUserdata($select,operators),$select=createValueView($cntr,groupId,memberId,variableObject.valueType,variableObject.value,defaultValue),$.isArray(variableObject.value)&&($($select[0]).aeCombo("reload",variableObject.value),$($select[0]).aeCombo("setDefault",variableObject.value[0].code)),addMemberEvents($memberView),condi=getCondition(memberId,variableObject.valueType),member=new Member(memberId,condi.variableName,condi.variable,condi.variableId,condi.operator,condi.operatorName,condi.value,condi.valueText,condi.valueType,condi.controlType,tmpl,tmplDisplay),expr.getGroup(groupId).addMember(member),ExpressionHelper.fireExprChangeEvent(exprId)}function hdDelMember(event){var $this=$(this),memberId=$this.attr("data-member-id");$("#"+memberId).fadeOut(400,function(){var group,$this=$(this),memberId=$this.attr("id"),groupId=$this.attr("data-group-id");group=ExpressionHelper.getGroup(groupId),group.removeMember(group.getMember(memberId)),$this.remove(),delGroupView(groupId),exprId=$("#"+groupId).attr("data-expr-id"),ExpressionHelper.fireExprChangeEvent(exprId)})}function delGroupView(groupId){var $cntr,parentGroupId,exprId,$g=$("#"+groupId),isRootGroup="1"===$g.attr("data-root-group");isRootGroup||($cntr=$g.children("[data-role='group-cntr']"),parentGroupId=$g.parent().attr("data-group-id"),exprId=$g.attr("data-expr-id"),0===$cntr.children("[data-role='member']").length&&0===$cntr.children("[data-role='member-group']").length&&(ExpressionHelper.delGroup(groupId),$g.fadeOut(400,function(){$(this).remove(),ExpressionHelper.fireExprChangeEvent(exprId),delGroupView(parentGroupId)})))}function hdEnumValueChange(event){var $this=$(this).parent().prev();_enumValueChange($this)}function _enumValueChange($span){var memberId,groupId,condi,member,exprId;groupId=$span.attr("data-group-id"),memberId=$span.attr("data-member-id"),member=ExpressionHelper.getGroup(groupId).getMember(memberId),condi=getCondition(memberId,0),member.value=condi.value,member.valueText=condi.valueText,member.valueType=condi.valueType,member.operator=condi.operator,member.controlType=condi.controlType,member.variable=condi.variable,member.variableId=condi.variableId,member.variableName=condi.variableName,exprId=$("#"+groupId).attr("data-expr-id"),ExpressionHelper.fireExprChangeEvent(exprId)}function hdVariableChange(event){var $this=$(this).parent().prev(),groupId=$this.attr("data-group-id"),$g=$("#"+groupId),exprId=$g.attr("data-expr-id"),memberId=$this.attr("data-member-id"),$member=$("#"+memberId),$el=$('[data-expr-inst-id="'+exprId+'"]'),option=$el.aeLogicBlock("option"),valueType=option.variables[$this.aeCombo("getIndex")].valueType;$member.find("[data-role='member-operator']").attr("data-value-type",valueType),$member.find("[data-role='member-value']").attr("data-value-type",valueType),$member.find("[data-role='member-value-enum']").attr("data-value-type",valueType),$member.find("[data-role='member-value-date']").attr("data-value-type",valueType).attr("data-group-id",groupId).attr("data-member-id",memberId),$member.find("[data-role='member-value-datetime']").attr("data-value-type",valueType).attr("data-group-id",groupId).attr("data-member-id",memberId),$member.find("[data-role='member-value-number']").attr("data-value-type",valueType).attr("data-group-id",groupId).attr("data-member-id",memberId),refreshOperators({groupId:groupId,memberId:memberId},option.variables[$this.aeCombo("getIndex")])}function getOptionValue($member,option,groupId){var variableId,mapVars=getMapVars(groupId);return option.hasCatalog?($variable=$member.find("[data-role='member-tree-button']"),variableId=$variable.attr("data-variable-id")):($variable=$member.find("[data-role='member-variable']"),idx=$variable.aeCombo("getIndex"),variableId=option.variables[idx].id),mapVars[variableId].value}function getDefaultValue($member){var $el,defaultValue,ud;return $el=$member.find("[data-role='member-operator']"),ud=$el.aeCombo("getUserdata",$el.aeCombo("getIndex")),defaultValue=ud.defaultValue}function hdOperatorChange(event){var $this=$(this).parent().prev();_operatorChange($this)}function _operatorChange($span){var valueType,controlType,ownerInfo,groupId=$span.attr("data-group-id"),memberId=$span.attr("data-member-id"),$g=$("#"+groupId),$member=$("#"+memberId),exprId=$g.attr("data-expr-id"),$el=$('[data-expr-inst-id="'+exprId+'"]'),option=$el.aeLogicBlock("option"),defaultValue=getDefaultValue($member),optionValue=getOptionValue($member,option,groupId);valueType=$span.attr("data-value-type"),controlType=parseInt($span.aeCombo("getUserdata",$span.aeCombo("getIndex")).controlType,10),ownerInfo={groupId:groupId,memberId:memberId,valueType:parseInt(valueType,10),controlType:controlType},refreshValues(ownerInfo,optionValue,defaultValue),updateValuesModel(ownerInfo)}function hdValueChange(event){null!==hdTimer&&(clearTimeout(hdTimer),hdTimer=null),$input=$(this),hdTimer=setTimeout(updateExpression,500)}function getNextOper(logicOperators,currentOperator){var i,count,item;if($.isArray(logicOperators))for(count=logicOperators.length,i=0;count>i;i++)if(item=logicOperators[i],item.code===currentOperator)return{current:logicOperators[i],next:logicOperators[i>=count-1?0:i+1]};return null}function hdChangeOper(event){var exprId,$this=$(this),operator=$this.attr("data-oper"),groupId=$this.attr("data-group-id"),$g=$("#"+groupId),group=ExpressionHelper.getGroup(groupId),logicOperators=$('[data-expr-inst-id="'+$g.attr("data-expr-id")+'"]').aeLogicBlock("option").logicOperators,logics=getNextOper(logicOperators,operator);null!==logics&&($g.removeClass(logics.current.color).addClass(logics.next.color),$this.attr("data-oper",logics.next.code).text(logics.next.text),group.operatorName=logics.next.text,group.operator=logics.next.code,exprId=$g.attr("data-expr-id"),ExpressionHelper.fireExprChangeEvent(exprId))}function disableMemberDroppable(exprId){var $els=$("[data-role='expr-cntr']").not("[data-expr-inst-id='"+exprId+"']");$els.find("[data-role='member']").aeDroppable("disable"),$els.find("[data-role='member-drop-tip']").aeDroppable("disable")}function enableMemberDroppable(exprId){var $els=$("[data-role='expr-cntr']").not("[data-expr-inst-id='"+exprId+"']");$els.find("[data-role='member']").aeDroppable("enable"),$els.find("[data-role='member-drop-tip']").aeDroppable("enable")}function disableGroupDroppable(exprId){disableMemberDroppable(exprId),$('[data-expr-inst-id="'+exprId+'"]').find("[data-role='member']").aeDroppable("disable")}function enableGroupDroppable(exprId){enableMemberDroppable(exprId),$('[data-expr-inst-id="'+exprId+'"]').find("[data-role='member']").aeDroppable("enable")}function hdStartDrag(event,ui){var $btns,$tips,$this=$(this),groupId=$this.attr("data-group-id"),$g=$("#"+groupId),exprId=$g.attr("data-expr-id"),$expr=$('[data-expr-inst-id="'+exprId+'"]');disableMemberDroppable(exprId),$expr.find("[data-role='member-icon']").not("[data-member-id='"+$this.attr("id")+"']").removeClass("ion-drag").addClass("ion-arrow-shrink"),$expr.find("[data-role='member-del']").hide(),$btns=$expr.find("[data-role='member-add']"),$btns.not("[data-group-id='"+groupId+"']").hide(),$tips=$expr.find("[data-role='member-drop-tip']"),$tips.not("[data-group-id='"+groupId+"']").show(),$this.css("z-index",9999)}function hdStartGroupDrag(event,ui){var $this=$(this),groupId=$this.attr("id"),$parentGroupCntr=$this.parent(),$g=$("#"+groupId),exprId=$g.attr("data-expr-id"),$expr=$('[data-expr-inst-id="'+exprId+'"]');disableGroupDroppable(exprId),$expr.find("[data-role='member-del']").hide(),$g.find("[data-role='member-add']").attr("data-excluder","1"),$g.find("[data-role='member-drop-tip']").attr("data-excluder","1"),$btns=$expr.find("[data-role='member-add']"),$btns.not("[data-excluder='1']").hide(),$tips=$expr.find("[data-role='member-drop-tip']"),$tips.not("[data-excluder='1']").show(),$parentGroupCntr.children("[data-role='member-add']").show(),$parentGroupCntr.children("[data-role='member-drop-tip']").hide(),$this.css("z-index",9999)}function hdStopDrag(event,ui){var $this=$(this),groupId=$this.attr("data-group-id"),exprId=$("#"+groupId).attr("data-expr-id"),$expr=$('[data-expr-inst-id="'+exprId+'"]');enableMemberDroppable(exprId),$expr.find("[data-role='member-icon']").not("[data-member-id='"+$this.attr("id")+"']").removeClass("ion-arrow-shrink").addClass("ion-drag"),$expr.find("[data-role='member-del']").show(),$expr.find("[data-role='member-add']").show(),$expr.find("[data-role='member-drop-tip']").hide(),$this.css({"z-index":0,width:"100%"})}function hdStopGroupDrag(event,ui){var $this=$(this),groupId=$this.attr("id"),$g=$("#"+groupId),exprId=$g.attr("data-expr-id"),$expr=$('[data-expr-inst-id="'+exprId+'"]');enableGroupDroppable(exprId),$expr.find("[data-role='member-del']").show(),$btns=$expr.find("[data-role='member-add']"),$btns.not("[data-excluder='1']").show(),$tips=$expr.find("[data-role='member-drop-tip']"),$tips.not("[data-excluder='1']").hide(),$g.find("[data-role='member-add']").attr("data-excluder","0"),$g.find("[data-role='member-drop-tip']").attr("data-excluder","0"),$this.css({"z-index":0,width:"100%"})}function hdOver(event,ui){var $this=$(this),dataRole=$this.attr("data-role");"member-drop-tip"===dataRole?$this.addClass("b-danger"):"member"===dataRole&&$this.addClass("b-danger")}function hdOut(event,ui){var $this=$(this),dataRole=$this.attr("data-role");"member-drop-tip"===dataRole?$this.removeClass("b-danger"):"member"===dataRole&&$this.removeClass("b-danger")}function hdDrop(event,ui){var $btn,newGroupId,exprId,groupId,groupView,prevGroupId,defaultLogicOperator,member,group,oldParentGroupId,parentGroupId,$el,$this=$(this),draggable=event.draggable,thisRole=$this.attr("data-role");return $this.removeClass("b-danger"),"member"===thisRole?(newGroupId=getId("gid"),$this.hide(),parentGroupId=$this.attr("data-group-id"),oldParentGroupId=draggable.attr("data-group-id"),exprId=$("#"+parentGroupId).attr("data-expr-id"),defaultLogicOperator=$('[data-expr-inst-id="'+exprId+'"]').aeLogicBlock("option").logicOperators[0],groupView=createMemberGroupView(newGroupId),groupView.addClass(defaultLogicOperator.color),groupView.find('[data-role="oper"]').text(defaultLogicOperator.text),groupView.attr("data-expr-id",$("#"+parentGroupId).attr("data-expr-id")),groupView.insertBefore($this),$el=$("#"+newGroupId),$btn=$el.find("[data-role='group-cntr']").children("[data-role='member-add']"),$this.insertBefore($btn),draggable.insertBefore($btn),$this.attr("data-group-id",newGroupId),$this.find("[data-group-id]").attr("data-group-id",newGroupId),draggable.attr("data-group-id",newGroupId),draggable.find("[data-group-id]").attr("data-group-id",newGroupId),$el.attr("data-expr-id",exprId),group=ExpressionHelper.addGroup(newGroupId,parentGroupId),member=ExpressionHelper.getGroup(parentGroupId).getMember($this.attr("id")),group.addMember(member),groupId=draggable.attr("data-group-id"),prevGroupId=groupId,member=ExpressionHelper.getGroup(oldParentGroupId).getMember(draggable.attr("id")),group.addMember(member),$this.show(),$el.find("[data-role='member-drop-tip']").aeDroppable({greedy:!0,drop:hdDrop,over:hdOver,out:hdOut}),$el.aeDraggable({handle:"[data-role='drag-handle']",revert:!0,distance:5,start:hdStartGroupDrag,stop:hdStopGroupDrag})):"member-drop-tip"===thisRole&&("member-group"===draggable.attr("data-role")?(groupId=draggable.attr("id"),group=ExpressionHelper.getGroup(groupId),$el=$("#"+groupId),exprId=$el.attr("data-expr-id"),prevGroupId=$el.parent().attr("data-group-id"),groupId=$this.attr("data-group-id"),$el=$("#"+groupId),$btn=$el.find("[data-role='member-add']").filter("[data-group-id='"+groupId+"']"),draggable.insertBefore($btn),ExpressionHelper.getGroup(groupId).addMember(group)):(groupId=draggable.attr("data-group-id"),prevGroupId=groupId,groupId=$this.attr("data-group-id"),$el=$("#"+groupId),exprId=$el.attr("data-expr-id"),$btn=$el.find("[data-role='member-add']").filter("[data-group-id='"+groupId+"']"),draggable.insertBefore($btn),draggable.attr("data-group-id",groupId),draggable.find("[data-group-id]").attr("data-group-id",groupId),member=ExpressionHelper.getGroup(prevGroupId).getMember(draggable.attr("id")),ExpressionHelper.getGroup(groupId).addMember(member))),prevGroupId&&delGroupView(prevGroupId),ExpressionHelper.fireExprChangeEvent(exprId),!1}function hdHalfOpacity(){var $this=$(this);$this.animate({opacity:.5,filter:"alpha(opacity=0.5)"},400)}function hdNotOpacity(){var $this=$(this);$this.stop().css({opacity:1,filter:"alpha(opacity=1)"})}function addGroupEvents($cntr){$cntr.on("click.aeLogicBlock","[data-role='member-add']",hdAddMember).on("click.aeLogicBlock","[data-role='group-del']",hdDelGroup).on("click.aeLogicBlock","[data-role='oper']",hdChangeOper).on("mouseover.aeLogicBlock","[data-role='drag-handle'],[data-role='group-del'],[data-role='member-add']",hdNotOpacity).on("mouseout.aeLogicBlock","[data-role='drag-handle'],[data-role='group-del'],[data-role='member-add']",hdHalfOpacity)}function removeGroupEvents($cntr){$cntr.off("click.aeLogicBlock").off("mouseover.aeLogicBlock").off("mouseout.aeLogicBlock")}function addMemberEvents($memberView){var inited=$memberView.data("inited");$memberView.on("click.aeLogicBlock","[data-role='member-del']",hdDelMember),$memberView.find("[data-role='member-variable']").aeCombo("option","onValueChange",hdVariableChange),$memberView.find("[data-role='member-operator']").aeCombo("option","onValueChange",hdOperatorChange),$memberView.find("[data-role='member-value']").on("keyup.aeLogicBlock",hdValueChange),$memberView.find("[data-role='member-value-enum']").aeCombo("option","onValueChange",hdEnumValueChange),inited?$memberView.aeDraggable("enable").aeDroppable("enable"):($memberView.data("inited",!0),$memberView.aeDraggable({handle:"[data-role='drag-handle']",revert:!0,distance:5,start:hdStartDrag,stop:hdStopDrag}).aeDroppable({greedy:!0,drop:hdDrop,over:hdOver,out:hdOut})),$memberView.find("[data-role='member-icon'],[data-role='member-del']").on("mouseover.aeLogicBlock",hdNotOpacity).on("mouseout.aeLogicBlock",hdHalfOpacity)}function removeMemberEvents($memberView){$memberView.off("click.aeLogicBlock"),$memberView.find("[data-role='member-variable']").off("change.aeLogicBlock"),$memberView.find("[data-role='member-operator']").off("change.aeLogicBlock"),$memberView.find("[data-role='member-value']").off("keyup.aeLogicBlock"),$memberView.find("[data-role='member-del']").off("mouseover.aeLogicBlock").off("mouseout.aeLogicBlock"),$memberView.aeDraggable("disable").aeDroppable("disable")}var tmplGroup,$input,tmplMember="<div class='panel panel-default m-b-sm' id='{{id}}' data-group-id='{{group_id}}' data-dock='true' data-role='member'><div class='pull-right pos-abt' style='right:15px;top:50%;margin-top:-10px;'><a href='javascript:void(0);'><i class='ion-close text-dark' data-role='member-del' data-group-id='{{group_id}}' data-member-id='{{id}}' style='opacity:0.5;filter:\"alpha(opacity=0.5)\"'></i></a></div><div class='inline-block v-middle pos-abt' style='cursor: move;left: 0px;top: 50%; margin-top: -25px;' data-role='drag-handle'><a class='text-center block text-muted m' style='cursor: move;opacity:0.5;filter:\"alpha(opacity=0.5)\"'><i class='ion-drag' data-member-id='{{id}}' data-role='member-icon'></i></a></div><div class='form-inline inline-block v-middle m-t-xs' data-role='member-cntr' style='padding:10px 40px 10px 40px;width:100%'></div></div>",hdTimer=null,CSS_HIGHLIGHT="bg-light lt",VAL_VAR="$ATTR_VALUE$",CTRL_NUM=1,CTRL_TEXT=2,CTRL_DATE=3,CTRL_ENUM=4,VALUE_TYPE_STR=1,VALUE_TYPE_DATE=3,VALUE_TYPE_DATETIME=4;$.ae.lang.aeLogicBlock={addNewCondition:"Add new condition",dropTip:"drop here add to the group",notFound:"No matching items."},tmplGroup="<div class='condition-group' id='{{id}}' data-role='member-group'><div class='condition-group-title'><span class='ion-drag pos-abt' data-role='drag-handle' style='cursor:move;top:10px;left:10px;opacity:0.5;filter:\"alpha(opacity=0.5)\"'></span><span class='ion-close pos-abt' data-role='group-del' style='cursor:pointer;bottom:10px;left:12px;opacity:0.5;filter:\"alpha(opacity=0.5)\"' data-group-id='{{id}}'></span><a class='inline-block text-white v-middle font-bold' data-role='oper' data-oper='and' data-group-id='{{id}}'>AND</a></div><div class='condition-group-content' data-role='group-cntr' data-dock='true' data-group-id='{{id}}'><button class='btn btn-default btn-block' data-role='member-add' style='opacity:0.5;filter:\"alpha(opacity=0.5)\"' data-group-id='{{id}}'>"+$.ae.lang.aeLogicBlock.addNewCondition+"</button><div class='b-gray text-center text-muted b-r b-2x b-dashed' style='height:32px;display:none' data-role='member-drop-tip' data-group-id='{{id}}'><span class='ion-arrow-shrink text-md'></span>"+$.ae.lang.aeLogicBlock.dropTip+"</div></div></div>",Expression.prototype={addGroup:function(group,parentGroup){parentGroup&&parentGroup instanceof MemberGroup?group instanceof MemberGroup&&(this.groups[group.id]=group,parentGroup.addMember(group)):this.root.addMember(group)},getGroup:function(groupId){return this.groups[groupId]||null},deleteGroup:function(groupId){groupId in this.groups&&(this.groups[groupId].gc(),delete this.groups[groupId])},toExpression:function(assembler,useLogicOperatorText){return this.root.toExpression(assembler,useLogicOperatorText)},getState:function(){var ky,obj={id:this.id,rootId:this.root.id,groups:[]},groups=this.groups;for(ky in groups)obj.groups.push(groups[ky].getState());return obj},_clear:function(){var ky;this.id="",this.root=null;for(ky in this.groups)this.groups[ky].gc(),delete this.groups[ky]},setState:function(state,mapVariables){var i,count,groupStates,ky,g,map={};if("object"==typeof state&&$.isArray(state.groups)&&state.groups.length>0){for(this._clear(),this.id=state.id,groupStates=state.groups,count=groupStates.length,i=0;count>i;i++)groupStates[i].id===state.rootId?(this.root=new MemberGroup({expr:this,id:groupStates[i].id}),map[this.root.id]=i,this.groups[this.root.id]=this.root):(g=new MemberGroup({expr:this,id:groupStates[i].id}),map[g.id]=i,this.groups[g.id]=g);for(ky in this.groups)g=this.groups[ky],g.setState(groupStates[map[g.id]],mapVariables);return!0}return!1},gc:function(){var ky,groups=this.groups;for(ky in groups)groups[ky].gc(),delete groups[ky];this.root=null}},Member.prototype={getState:function(){return{id:this.id,value:this.value,valueText:this.valueText,valueType:this.valueType,controlType:this.controlType,operator:this.operator,operatorName:this.operatorName,variableName:this.variableName,variableId:this.variableId,variable:this.variable,template:this.template,displayTemplate:this.displayTemplate,parentGroupId:this.parentGroup.id}},gc:function(){this.parentGroup=null}},MemberGroup.prototype={getState:function(){var i,state={id:this.id,members:[],operator:this.operator,operatorName:this.operatorName,parentGroupId:null===this.parentGroup?"":this.parentGroup.id},ms=this.members,count=ms.length;for(i=0;count>i;i++)ms[i]instanceof MemberGroup?state.members.push({id:ms[i].id,isGroup:"1"}):state.members.push(ms[i].getState());return state},setState:function(state,mapVariables){var i,count,ms,group,member;for(this.operator=state.operator,this.operatorName=state.operatorName,this.id=state.id,this.parentGroup=this.expr.getGroup(state.parentGroupId),ms=state.members,this.members=[],count=ms.length,i=0;count>i;i++)"1"===ms[i].isGroup?(group=this.expr.getGroup(ms[i].id),this.members.push(group)):(member=new Member(ms[i].id,ms[i].variableName,ms[i].variable,ms[i].variableId,ms[i].operator,ms[i].operatorName,ms[i].value,ms[i].valueText,parseInt(ms[i].valueType,10),parseInt(ms[i].controlType,10),ms[i].template,ms[i].displayTemplate,this),this.members.push(member))},toExpression:function(assembler,useLogicOperatorText){var i,result,idx,exprStr,tmplStr,userData,ms=this.members,count=ms.length,s="",$expr=$('[data-expr-inst-id="'+this.expr.id+'"]'),opts=$expr.aeLogicBlock("option"),tmplParser=opts.templateParser,mapVariables=$expr.data("map_vars");for(i=0;count>i;i++)ms[i]instanceof MemberGroup?s+=ms[i].toExpression(assembler,useLogicOperatorText):"function"==typeof assembler?(userData=mapVariables[ms[i].variableId].userData,result=assembler({variableCode:ms[i].variable,variableName:ms[i].variableName,operatorCode:ms[i].operator,operatorName:ms[i].operatorName,value:ms[i].value,valueText:ms[i].valueText,valueType:ms[i].valueType,template:ms[i].template,displayTemplate:ms[i].displayTemplate,templateParser:opts.templateParser,userData:userData}),"string"==typeof result?s+=result:result===!1&&(tmplStr=ms[i].template,exprStr="string"==typeof tmplStr&&""!==tmplStr?tmplParser(ms[i].variable,ms[i].value,tmplStr):ms[i].variable+ms[i].operator+ms[i].value,s+=" "+exprStr+" ")):(tmplStr=ms[i].template,exprStr="string"==typeof tmplStr&&""!==tmplStr?tmplParser(ms[i].variable,ms[i].value,tmplStr):ms[i].variable+ms[i].operator+ms[i].value,s+=" "+exprStr+" "),i!==count-1&&(s+=" "+(useLogicOperatorText?this.operatorName:this.operator)+" ");return idx=s.lastIndexOf(this.operator),idx===s.length-this.operator.length&&(s=s.substr(0,idx)),"("+s+")"},hasMember:function(member){var i,count,id,ms=this.members;if(member instanceof Member||member instanceof MemberGroup)for(id=member.id,i=0,count=ms.length;count>i;i++)if(ms[i].id===id)return i;return-1},getMember:function(memberId){var i,members=this.members;for(i=members.length-1;i>=0;i--)if(members[i].id===memberId)return members[i];return null},addMember:function(member){var idx,isMemberGroup=member instanceof MemberGroup;(member instanceof Member||isMemberGroup)&&(idx=this.hasMember(member),-1===idx&&(member.parentGroup instanceof MemberGroup&&member.parentGroup.removeMember(member),member.parentGroup=this,this.members.push(member)))},removeMember:function(member){var i,ms=this.members,id=member.id;for(i=ms.length-1;i>=0;i--)if(ms[i].id===id){ms.splice(i,1);break}},gc:function(){var i,members=this.members;for(i=members.length-1;i>=0;i--)members[i]instanceof MemberGroup&&members[i].gc(),members.splice(i,1);null!==this.parentGroup&&(this.parentGroup.removeMember(this),this.parentGroup=null),this.expr=null}};var ExpressionHelper={addGroup:function(groupId,parentGroupId){var exprId,expr,group,$expr,opts,parentGroup;return exprId=$("#"+groupId).attr("data-expr-id"),$expr=$('[data-expr-inst-id="'+exprId+'"]'),expr=$expr.data("expr"),opts=$expr.aeLogicBlock("option"),defaultLogicOperator=opts.logicOperators[0],group=new MemberGroup({id:groupId,expr:expr,operatorName:defaultLogicOperator.text,operator:defaultLogicOperator.code}),parentGroup=expr.getGroup(parentGroupId),expr.addGroup(group,parentGroup),group},getExpr:function(groupId){var exprId=$("#"+groupId).attr("data-expr-id"),expr=$('[data-expr-inst-id="'+exprId+'"]').data("expr");return expr?expr:null},getGroup:function(groupId){var exprId=$("#"+groupId).attr("data-expr-id"),expr=$('[data-expr-inst-id="'+exprId+'"]').data("expr");return expr?expr.getGroup(groupId):null},delGroup:function(groupId){var exprId=$("#"+groupId).attr("data-expr-id"),expr=$('[data-expr-inst-id="'+exprId+'"]').data("expr");expr.deleteGroup(groupId)},fireExprChangeEvent:function(exprId){var $elExpr=$('[data-expr-inst-id="'+exprId+'"]');$elExpr.aeLogicBlock("option").onExprChange.call($elExpr)}};window.hdDateChange=hdDateChange,window.hdVariablesTreeSelect=hdVariablesTreeSelect,$.aeWidget("ae.aeLogicBlock",{options:{variables:null,logicOperators:[{text:"AND",code:"and",color:"bg-info"},{text:"OR",code:"or",color:"bg-success"}],hasCatalog:!1,onExprChange:$.noop,assembler:null,templateParser:defaultTemplateParser},_create:function(){var $el=this.element,exprId=$el.attr("id"),groupId=getId("gid");this._hdTimer=null,exprId||(exprId=getId("expr"),$el.attr("id",exprId)),$el.attr("aeId",$el.attr("id")),this._initModel(exprId,groupId),this._initView(exprId,groupId)},_initSearchbar:function(){var exprId,$dlg;this._$tree||(exprId=this.element.data("expr").id,$dlg=$("#logicblock-"+exprId),this._$tree=$dlg.find('[data-role="var-tree"]'),this._$result=$dlg.find('[data-role="result"]'),this._$result.on("mouseover.aeLogicBlock","li",this,function(event){$(this).addClass(CSS_HIGHLIGHT)}).on("mouseout.aeLogicBlock","li",this,function(event){$(this).removeClass(CSS_HIGHLIGHT)}).on("click.aeLogicBlock","li",this,function(event){var inst=event.data,nodeId=$(this).attr("data-node-id");inst._gotoNode(nodeId)}),this._$input=$dlg.find('[data-role="search-input"]'),this._$input.on("keyup.aeLogicBlock",this,function(event){var $el,inst=event.data,selector=".bg-light";switch(null!==inst._hdTimer&&(clearTimeout(inst._hdTimer),inst._hdTimer=null),event.which){case 27:return $(this).trigger("blur.aeLogicBlock",inst),!1;case 13:inst._nodeId&&inst._gotoNode(inst._nodeId);break;case 38:return $el=inst._$result.find("li").eq(0),inst._nodeId&&inst._nodeId===$el.attr("data-node-id")||($el=inst._$result.find(selector),$el.length>0&&($el=$el.removeClass(CSS_HIGHLIGHT).prev().addClass(CSS_HIGHLIGHT),inst._nodeId=$el.attr("data-node-id"))),!1;case 40:return $el=inst._$result.find("li").filter(":last"),inst._nodeId&&inst._nodeId===$el.attr("data-node-id")||($el=inst._$result.find(selector),$el=0===$el.length?inst._$result.find("li").eq(0).addClass(CSS_HIGHLIGHT):$el.removeClass(CSS_HIGHLIGHT).next().addClass(CSS_HIGHLIGHT),
inst._nodeId=$el.attr("data-node-id")),!1}inst._$input.parent().find('[data-role="search-clear"]').show(),inst._hdTimer=setTimeout($.proxy(inst._refreshResults,inst),300)}).parent().find('[data-role="search-clear"]').on("click.aeLogicBlock",this,function(event){event.data._resetDialog()}))},_resetDialog:function(){this._nodeId=null,this._$input.parent().find('[data-role="search-clear"]').hide(),this._$input.val(""),this._$result.hide(),this._$tree.show()},_gotoNode:function(nodeId){var $tree=this._$tree.find('[aeType="aeTree"]');$tree.aeTree("expandNode",nodeId),$tree.aeTree("selectNode",nodeId),this._$result.hide(),this._$tree.show()},_refreshResults:function(){var value,nodeIds,$notFound=this._$result.find('[data-role="not-found"]');$notFound.hide().siblings().remove(),value=this._$input.val(),""===value?(this._$input.parent().find('[data-role="search-clear"]').hide(),this._$result.hide(),this._$tree.show()):(value.length>=1&&(nodeIds=this._search(value),nodeIds.length>0?this._reloadResult(nodeIds):$notFound.show()),this._$tree.hide(),this._$result.show())},_search:function(condition){var cache,nodeId,item,exprId=this.element.data("expr").id,$el=$("#logicblock-"+exprId).find("[data-role='member-tree']"),arr=[],lowerCase=condition.toLowerCase();if($el.length>0){cache=$el.data("nodes");for(nodeId in cache)item=cache[nodeId],item&&void 0!==item.valueType&&"string"==typeof item.name&&item.name.toLowerCase().indexOf(lowerCase)>=0&&arr.push({id:nodeId,info:item})}return arr},_reloadResult:function(nodeInfos){var i,count=nodeInfos.length,s="";for(i=0;count>i;i++)s+=getResultItemString(nodeInfos[i].id,nodeInfos[i].info);this._$result.append($(s))},_preprocessVariables:function(){var operators,oper,i,j,variables=this.options.variables,mapVars={};for(i=variables.length-1;i>=0;i--)if($.isArray(variables[i].operators)){for(variables[i].value=variables[i].value||null,variables[i].valueType=parseInt(variables[i].valueType,10),operators=variables[i].operators,j=operators.length-j;j>=0;j--)oper=operators[j],oper.noValue=oper.template.indexOf(VAL_VAR)<0,oper.template=oper.template||"",oper.controlType=parseInt(oper.controlType,10),"string"!=typeof oper.defaultValue&&(oper.defaultValue=null);mapVars[variables[i].id]=variables[i]}this.element.data("map_vars",mapVars)},_initModel:function(exprId,groupId){var expr,defaultLogicOperator=this.options.logicOperators[0];return expr=new Expression(exprId,groupId,defaultLogicOperator.text,defaultLogicOperator.code),this._preprocessVariables(),this.element.attr("data-expr-inst-id",exprId).data("expr",expr),expr},_initView:function(exprId,groupId){var $el=this.element,$g=createMemberGroupView(groupId);return $g.find('[data-role="oper"]').text(this.options.logicOperators[0].text),$g.attr("aeType","aeLogicBlock").attr("data-expr-id",exprId).attr("data-root-group","1"),$g.addClass(this.options.logicOperators[0].color),$el.attr("data-root-gid",groupId).prepend($g),$g.find("[data-role='drag-handle']").remove(),$g.find("[data-role='group-del']").remove(),$g.find("[data-role='member-drop-tip']").aeDroppable({greedy:!0,drop:hdDrop,over:hdOver,out:hdOut}),addGroupEvents($el),this.options.hasCatalog&&this._initVariableTreeDialog(exprId),$g},_initVariableTreeDialog:function(exprId){var $dlg,$tree;$dlg=createVariableTreeDialogView(exprId,this.options.variables),$tree=$dlg.find("[data-role='member-tree']"),$tree.aeTree({}),$tree.aeTree("remove"),$tree.aeTree("reload",this.options.variables)},enable:function(){var i,el=this.element,$members=el.find("[data-role='member']");for(addGroupEvents(el),el.find("[data-role='member-group']").not("[data-root-group]").aeDraggable("enable"),el.find("[data-role='oper']").css("cursor","hand"),el.find("[data-role='group-del']").show(),el.find("[data-role='drag-handle']").show(),el.find("[data-role='member-variable']").aeCombo("enable",!0),el.find("[data-role='member-operator']").aeCombo("enable",!0),el.find("[data-role='member-value']").attr("disabled",!1),el.find("[data-role='member-value-enum']").aeCombo("enable",!0),el.find("[data-role='member-value-number']").aeFlip("enable",!0),el.find("[data-role='member-tree-button']").attr("disabled",!1),el.find("[data-role='member-del']").show(),el.find("[data-role='member-add']").show(),i=$members.length-1;i>=0;i--)addMemberEvents($($members[i]))},disable:function(){var i,el=this.element,$members=el.find("[data-role='member']");for(removeGroupEvents(el),el.find("[data-role='member-group']").not("[data-root-group]").aeDraggable("disable"),el.find("[data-role='oper']").css({cursor:"default"}),el.find("[data-role='group-del']").hide(),el.find("[data-role='drag-handle']").hide(),el.find("[data-role='member-variable']").aeCombo("enable",!1),el.find("[data-role='member-operator']").aeCombo("enable",!1),el.find("[data-role='member-value']").attr("disabled",!0),el.find("[data-role='member-value-enum']").aeCombo("enable",!1),el.find("[data-role='member-value-number']").aeFlip("enable",!1),el.find("[data-role='member-tree-button']").attr("disabled",!0),el.find("[data-role='member-del']").hide(),el.find("[data-role='member-add']").hide(),i=$members.length-1;i>=0;i--)removeMemberEvents($($members[i]))},toExpression:function(assembler,useLogicOperatorText){var expr=this.element.data("expr");return expr.toExpression(assembler||this.options.assembler,useLogicOperatorText)},getState:function(){var expr=this.element.data("expr");return expr.getState()},_clear:function(){var expr=this.element.data("expr"),exprId=expr.id;return groupId=expr.root.id,expr.gc(),this.element.off(".aeLogicBlock"),this.element.empty(),$("#logicblock-"+exprId).remove(),{exprId:exprId,groupId:groupId}},_getVariableObject:function(variables,vairableName){var i;for(i=variables.length-1;i>=0;i--)if(variables[i].name===vairableName)return variables[i];return null},_getLogicOperator:function(operCode){var i,logicOperators=this.options.logicOperators;for(i=logicOperators.length-1;i>=0;i--)if(logicOperators[i].code===operCode)return logicOperators[i];return null},_reloadViews:function($parentGroupView,members){var i,count,$btn,$oper,exprId,$expr,$btnSelectTree,$select,groupId,memberId,$groupView,$elOpers,optValueChange,logicOperator,$memberView,variableObject,ownerInfo,options=this.options;for(count=members.length,$btn=$parentGroupView.find("[data-role='group-cntr']").children("[data-role='member-add']"),i=0;count>i;i++)members[i]instanceof MemberGroup?($groupView=createMemberGroupView(members[i].id),$groupView.attr("data-expr-id",$parentGroupView.attr("data-expr-id")),$groupView.insertBefore($btn),logicOperator=this._getLogicOperator(members[i].operator),null!==logicOperator&&($oper=$groupView.find("[data-role='oper']"),$oper.attr("data-oper",logicOperator.code).text(logicOperator.text),groupId=$oper.attr("data-group-id"),$("#"+groupId).addClass(logicOperator.color)),$groupView.find("[data-role='member-drop-tip']").aeDroppable({greedy:!0,drop:hdDrop,over:hdOver,out:hdOut}),$groupView.aeDraggable({handle:"[data-role='drag-handle']",revert:!0,distance:5,start:hdStartGroupDrag,stop:hdStopGroupDrag}),this._reloadViews($groupView,members[i].members)):(groupId=$parentGroupView.attr("id"),memberId=members[i].id,$memberView=createMemberView(groupId,memberId),$memberView.insertBefore($btn),$cntr=$memberView.find("[data-role='member-cntr']"),variableObject=this._getVariableObject(options.variables,members[i].variableName),null===variableObject&&(variableObject=getFirstVariableObject(options.variables)),this.options.hasCatalog?($btnSelectTree=createVariableTreeButtonView(groupId,memberId,options.variables),$btnSelectTree.attr("data-code",members[i].variable).attr("data-variable-id",members[i].variableId).text(members[i].variableName),$cntr.append($btnSelectTree),$btnSelectTree.on("click.aeLogicBlock",hdTreeButtonClick)):($select=createVariableView(groupId,memberId,options.variables,variableObject.name),$cntr.append($select),$select.aeCombo({}),$select.next().addClass("m-b-xs"),$select.aeCombo("reload",options.variables),$select.aeCombo("setDefault",options.variables[0].id),setVariablesUserData($select,options.variables)),$elOpers=createOperatorView(groupId,memberId,variableObject,members[i].operator),$cntr.append($elOpers),$elOpers.aeCombo({}),$elOpers.next().addClass("m-b-xs"),$elOpers.aeCombo("reload",variableObject.operators),$elOpers.aeCombo("setDefault",members[i].operator),setOperatorsUserdata($elOpers,variableObject.operators),$select=createValueView($cntr,groupId,memberId,members[i].valueType,members[i].value,members[i].defaultValue),addMemberEvents($memberView),optValueChange=$elOpers.aeCombo("option").onValueChange,$elOpers.aeCombo("option","onValueChange",null),$elOpers.aeCombo("setValue",members[i].operator),$elOpers.aeCombo("option","onValueChange",optValueChange),ownerInfo={groupId:groupId,memberId:memberId,valueType:parseInt(members[i].valueType,10),controlType:parseInt(members[i].controlType,10)},exprId=$("#"+groupId).attr("data-expr-id"),$expr=$('[data-expr-inst-id="'+exprId+'"]'),optionValue=members[i].value,"?"===optionValue&&(optionValue=""),refreshValues(ownerInfo,optionValue,members[i].valueText),$.isArray(variableObject.value)&&($($select[0]).aeCombo("reload",variableObject.value),$($select[0]).aeCombo("setDefault",members[i].value||variableObject.value[0].code)),updateValuesModel(ownerInfo))},clear:function(){var oldIds=(getId("gid"),this._clear());this._initModel(oldIds.exprId,oldIds.groupId),this._initView(oldIds.exprId,oldIds.groupId),ExpressionHelper.fireExprChangeEvent(oldIds.exprId)},_reloadRoot:function($root,state){var $glbl,i,item,groups=state.groups,operator=null;for($glbl=$root.find("[data-role='oper']"),i=groups.length-1;i>=0;i--)groups[i].id===state.rootId&&(operator=groups[i].operator);null!==operator&&(item=this._getLogicOperator(operator),$glbl.attr("data-oper",item.code).text(item.text),$("#"+$root.attr("id")).addClass(item.color))},reload:function(state){var expr,members,oldIds,$g,mapVariables;oldIds=this._clear(),expr=this._initModel(state.id,state.rootId),mapVariables=this.element.data("map_vars"),expr.setState(state,mapVariables),$g=this._initView(state.id,state.rootId),this._reloadRoot($g,state),members=expr.root.members,this._reloadViews($g,members),ExpressionHelper.fireExprChangeEvent(state.id)},_destroy:function(){null!==this._hdTimer&&(clearTimeout(this._hdTimer),this._hdTimer=null),this._$input.off(".aeLogicBlock"),this._$input.remove(),this._$input=null,this._$result.remove(),this._$result=null,this._clear()}})}),define("ui-notice",function(require,exports,moudles){$.ae.lang.aeNotice={success:"Success",error:"Error",warning:"Warning",message:"Message",notify:"Notification",annunciate:"Announcement",rss:"Rss"},$.aeWidget("ae.aeNotice",{options:{life:3e3,type:"success",title:"Tips",content:null,audio:"/ARIESRES/crm-bj/fe-common/audio/blop",volume:"45",autoClose:!0,verticalEdge:"bottom",horizontalEdge:"right",zindex:"1060",icon:"md-close",onCreate:null,onClose:null,clickEvent:null},_create:function(){var i,containers=[],pos=[{h:"right",v:"top"},{h:"right",v:"bottom"},{h:"center",v:"top"},{h:"center",v:"bottom"},{h:"left",v:"top"},{h:"left",v:"bottom"}];for(i=0;5>=i;i++)containers[i]=$("<div></div>"),containers[i].attr("id",pos[i].h+""+pos[i].v),containers[i].addClass("notice-container "+pos[i].h+" "+pos[i].v),this.element.append(containers[i]);this.containers=containers,this.pos=pos},_createNotice:function(options){var i,h,pos,container,v=options.verticalEdge;for(h=options.horizontalEdge,pos={h:h,v:v},i=0;i<this.pos.length;i++)if(pos.h===this.pos[i].h&&pos.v===this.pos[i].v){container=this.containers[i];break}this.container=container,this._buildNotification(options)},open:function(options){var opts=$.extend({},this.options,options);this._createNotice(opts)},_buildNotification:function(options){var $container,$notification,notificationId,num,self,target;$container=this.container,num=$container.data("notice")||0,num+=1,$container.data("notice",num),notificationId="notice-notification-"+num,$container.css("z-index",options.zindex),$notification=$('<div class="r clear m-t-xs"></div>'),window.top===window.self&&$container.addClass("is-top-frame"),"dark"===options.type&&$notification.addClass("text-white"),$notification.attr("id",notificationId),this._hasContent(options)?($notification.addClass("notice-notification"),"light"===options.type&&$notification.addClass("b")):$notification.addClass("notice-notificationNoContent"),"bottom"===options.verticalEdge?$notification.addClass("up"):$notification.addClass("down"),$notification.addClass("bg-"+options.type),$notification.append(this._buildIcon(options)),$notification.append(this._buildContent(options)),$container.append($notification),this._playAudio({url:options.audio,volume:options.volume}),$.isFunction(options.onCreate)===!0&&options.onCreate.call(),self=this,target=$("#"+options.horizontalEdge+options.verticalEdge+">#"+notificationId),options.autoClose&&setTimeout(function(dom,opts){target&&self._closeNotification(dom,opts)},options.life,$notification,options),target.on("click",".md-close",{inst:this,opts:options},function(event){var data=event.data;data.inst._closeNotification(target,data.opts)}),target.find(".rightArea .content").on("click",{inst:this,opts:options},function(event){var data=event.data;$.isFunction(data.opts.clickEvent)===!0&&data.opts.clickEvent.call(data.inst.element)})},_hasIcon:function(options){return"string"==typeof options.icon&&""!==options.icon},_buildIcon:function(options){if(this._hasIcon(options)){var iconContainer=$('<div class="pull-left text-center"></div>'),icon=$("<i class="+options.icon+"/>");return icon.addClass("text-2x"),this._hasContent(options)?iconContainer.addClass("notice-top-icon"):(icon.addClass("notice-pos-center"),iconContainer.addClass("nonotice-iconNoContent")),iconContainer.append(icon),iconContainer[0].outerHTML}return""},_buildContent:function(options){var detailDiv,rightArea=$("<div></div>"),content=$("<div class='pull-left'></div>"),titleDiv=$("<div></div>");return this._hasContent(options)?(titleDiv.addClass("m-t-xs"),rightArea.addClass("rightArea"),"light"===options.type&&rightArea.addClass("b-l")):(titleDiv.addClass("notice-pos-center"),rightArea.addClass("rightAreaNoContent")),titleDiv.append('<span class="text-base font-medium" title="'+(options.title||"Tips")+'">'+(options.title||"Tips")+"</span>"),content.append(titleDiv),this._hasContent(options)&&(detailDiv=$("<div class='m-t-xs m-b-xs notice-subText'><span class='text-base'></span></div>"),detailDiv.find("span").text(options.content),content.append(detailDiv)),rightArea.addClass(options.type+" lt pull-right"),content.addClass("content"),rightArea.append(content),rightArea.append(this._buildClose(options)),rightArea[0].outerHTML},_buildClose:function(options){var container=$('<div class="pull-right m-r-sm"></div>'),close=$('<a><i class="md-close"></i></a>');return this._hasContent(options)?container.addClass("notice-top-close"):close.addClass("notice-pos-center"),container.append(close),container},_playAudio:function(options){options=options||{};var $this=$(this);$this._audio=$this._audio||{};var userAgent=navigator.userAgent.toLowerCase();if($this.IE8=-1!=userAgent.indexOf("msie")&&8==parseInt(userAgent.split("msie")[1]),!options.url||$this.IE8)return this;if(!$this._audio[options.url]){var audio=jQuery("<audio/>");jQuery("<source/>",{src:options.url+".mp3"}).appendTo(audio),jQuery("<source/>",{src:options.url+".ogg"}).appendTo(audio),$this._audio[options.url]=audio[0]}$this._audio[options.url].volume=Math.min(void 0!==options.volume?options.volume:(void 0!==$this.options.volume?$this.options.volume:100)/100,1),$this._audio[options.url].pause();try{$this._audio[options.url].currentTime=0}catch(e){}$this._audio[options.url].play()},_hasContent:function(options){return"string"==typeof options.content&&""!==options.content?!0:!1},_closeNotification:function(n,opts){var num=this.container.data("notice");n.fadeOut("slow",function(){n.remove()}),num--,$.isFunction(opts.onClose)===!0&&opts.onClose.call(this.element),this.container.data("notice",0>num?0:num)}}),$(document.body).aeNotice(),$.Notice=function(options){$(document.body).aeNotice("open",options)};var obj={success:function(title,content,cbClick,cbClose,cbCreate){content&&title?title+=": "+content:content&&(title=content);var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.success,type:"success",verticalEdge:"top",horizontalEdge:"center",icon:"check_circle",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/blop"})},error:function(title,content,cbClick,cbClose,cbCreate){content&&title?title+=": "+content:content&&(title=content);var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.error,type:"danger",content:null,verticalEdge:"top",horizontalEdge:"center",icon:"close_circle",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/blop"})},warning:function(title,content,cbClick,cbClose,cbCreate){content&&title?title+=": "+content:content&&(title=content);var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.warning,type:"warning",verticalEdge:"top",horizontalEdge:"center",icon:"warning",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/blop"})},info:function(title,content,cbClick,cbClose,cbCreate){content&&title?title+=": "+content:content&&(title=content);var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.warning,type:"info",verticalEdge:"top",horizontalEdge:"center",icon:"error",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/blop"})},message:function(title,content,cbClick,cbClose,cbCreate){var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.message,type:"light",content:content,icon:"message_text_outline2",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/boop2"})},messageDark:function(title,content,cbClick,cbClose,cbCreate){var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.message,type:"dark",content:content,icon:"message_text_outline2",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/boop2"})},notify:function(title,content,cbClick,cbClose,cbCreate){var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.notify,type:"light",content:content,icon:"notifications_none",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/boop2"})},annunciate:function(title,content,cbClick,cbClose,cbCreate){var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.annunciate,type:"light",content:content,icon:"bullhorn",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/boop2"})},rss:function(title,content,cbClick,cbClose,cbCreate){var i18n=$.ae.lang.aeNotice;$.Notice({title:title||i18n.annunciate,type:"light",content:content,icon:"rss",clickEvent:$.isFunction(cbClick)?cbClick:null,onClose:$.isFunction(cbClose)?cbClose:null,onCreate:$.isFunction(cbCreate)?cbCreate:null,audio:"/ARIESRES/crm-bj/fe-common/audio/boop2"})}};$.Notice.success=obj.success,$.Notice.info=obj.info,$.Notice.warning=obj.warning,$.Notice.error=obj.error,$.Notice.message=obj.message,$.Notice.messageDark=obj.messageDark,$.Notice.notify=obj.notify,$.Notice.annunciate=obj.annunciate,$.Notice.rss=obj.rss}),define("ui-htree",function(require,exports,moudles){function isImgIcon(icon){return icon.indexOf(".")>=0}function hdCheck(inst,nodeId){var affectedNodes,$this=$(this),selected=$this.hasClass(CSS_OUTLINE);return affectedNodes=inst.setSelected(nodeId,selected),inst._updateSelectedNodes(affectedNodes),affectedNodes}function addChilds($el,inst,node,opts){node.loading===!1&&$.isFunction(opts.source)&&($el.find('[data-role="htree-icon"]').hide(),$el.find('[data-role="htree-loading"]').show(),node.loading=!0,opts.source.call(inst.element,node.getState()))}function hdSelect(inst,nodeId){var changed,hasChildren,$el,$item,nd,ndCurrent,affectedNodes,orgNodeId,$this=$(this),selector="."+CSS_ACTIVE,opts=inst.options,lazyLoadMode=opts.lazyLoadMode;nd=inst._nodes[nodeId],changed=!$this.hasClass(CSS_ACTIVE),$el=$this.siblings(selector).removeClass(CSS_ACTIVE),$el.length>0&&(orgNodeId=$el.attr("data-node-id"),inst._nodes[orgNodeId].getChildCount()>0&&($el=$el.find('[data-role="htree-icon"]'),isImgIcon(inst._nodes[orgNodeId].foldedIcon)?$el.attr("src",inst._nodes[orgNodeId].foldedIcon):$el.removeClass().addClass(inst._nodes[orgNodeId].foldedIcon))),changed?($this.addClass(CSS_ACTIVE),lazyLoadMode&&nd.isLazy?addChilds($this,inst,nd,opts):nd.getChildCount()>0&&($el=$this.find('[data-role="htree-icon"]'),isImgIcon(nd.expandedIcon)?$el.attr("src",nd.expandedIcon):$el.removeClass().addClass(nd.expandedIcon))):lazyLoadMode&&nd.isLazy&&addChilds($this,inst,nd,opts),hasChildren=nd.getChildCount()>0,null===nd.pid?changed?(inst._$sub.empty(),hasChildren&&inst._$sub.append(generateList("",inst._getChilrenById(nodeId),opts))):($el=inst._$sub.find('[data-role="htree-list"]:eq(0)'),$item=$el.find(selector),$item.length>0&&($item.removeClass(CSS_ACTIVE),ndCurrent=inst._nodes[$item.attr("data-node-id")],ndCurrent.getChildCount()>0&&(isImgIcon(nd.foldedIcon)?$item.attr("src",nd.foldedIcon):$item.find('[data-role="htree-icon"]').removeClass().addClass(nd.foldedIcon))),$el.nextAll().remove()):($el=$this.parents('[data-role="htree-list"]:eq(0)'),changed?($el.nextAll().remove(),hasChildren&&inst._$sub.append(generateList("",inst._getChilrenById(nodeId),opts))):hasChildren&&($el=$el.nextAll(),$item=$($el[0]).find(selector),$item.length>0&&($item.removeClass(CSS_ACTIVE),ndCurrent=inst._nodes[$item.attr("data-node-id")],ndCurrent.getChildCount()>0&&(isImgIcon(nd.foldedIcon)?$item.attr("src",ndCurrent.foldedIcon):$item.find('[data-role="htree-icon"]').removeClass().addClass(ndCurrent.foldedIcon))),$el.slice(1).remove())),opts.mutiSelect===!1&&(changed?orgNodeId&&(affectedNodes=inst._nodes[orgNodeId].setSelected(inst._nodes,inst._levels,!1),inst._updateSelectedNodes(affectedNodes)):inst._clearSelectedList(),nd.setSelected(inst._nodes,inst._levels,!0,!1,!0),inst._updateSelectedNodes(inst._getAncestorsById(nodeId,!0)))}function getRelativeFlags(mutiSelectMode){var obj={noRelativeAncestors:!1,noRelativeDescendants:!1};switch(mutiSelectMode){case 1:obj.noRelativeAncestors=!0;break;case 2:obj.noRelativeDescendants=!0;break;case 3:obj.noRelativeAncestors=!0,obj.noRelativeDescendants=!0}return obj}function HTreeNode(nodeState,options){var opts=options||{};this.id=nodeState.id,this.pid=nodeState.pid||null,this.rootId=nodeState.rootId||null,this.name=nodeState.name||"",this.level=isNaN(nodeState.level)?0:parseInt(nodeState.level,10),this.selected=!!nodeState.selected,this.foldedIcon=nodeState.foldedIcon||opts&&opts.foldedIcon||FOLDER_ICON,this.expandedIcon=nodeState.expandedIcon||opts&&opts.expandedIcon||FOLDER_ICON,this.leafIcon=nodeState.leafIcon||opts&&opts.leafIcon||FILE_ICON,this.blurryIcon=nodeState.blurryIcon||opts&&opts.blurryIcon||FOLDER_BLURRY_ICON,this.userData=nodeState.userData||null,this.childInfo={children:null,selectedCount:0},this.isIndeterminate=!!nodeState.isIndeterminate,this.isLazy=void 0===nodeState.isLazy?!0:!!nodeState.isLazy,this.loading=!1}function getCheckCSS(childInfo){var i,children=childInfo.children,count=0;if(null!==children)for(count=children.length,i=count-1;i>=0;i--)if(children[i].isIndeterminate)return CSS_INDETERMINATE;return count===childInfo.selectedCount?CSS_CHECKED:0===childInfo.selectedCount?CSS_OUTLINE:CSS_INDETERMINATE}function generateSkeleton(){var s='<div class="node-selection-search" data-role="htree-search-bar"><i class="close_circle pull-right none" data-role="htree-search-clear"></i><i class="search"></i><input type="text" class="node-search-input" data-role="htree-search"/></div><ul class="node-selection-result none" data-role="htree-result"></ul><div class="node-selection-tree" data-role="htree-tree"><div class="main-column" data-role="htree-main-list"></div><div class="branch-columns" data-role="htree-sub-list"></div></div>';return s+=getFooterString(),$(s)}function getFooterString(){var i18n=$.ae.lang.aeHTree,s='<div class="node-selection-footer pos-rlt" data-role="htree-footer"><button class="btn btn-primary pull-right" type="button" data-role="htree-ok">'+i18n.select+'</button> <button class="btn btn-default pull-right m-r-sm" type="button" data-role="htree-cancel">'+i18n.cancel+'</button><span class="node-selection-selected-num" data-role="htree-tips">',sCount='<a tabindex="0" role="button" data-toggle="popover" data-trigger="click" class="text-primary font-medium" date-role="htree-count">0</a>';return s+=i18n.selectedCount.replace("?",sCount),s+='</span><div class="have-selected-popover none" data-role="htree-popover"><i class="window_close" data-role="htree-win-close"></i></div></div>'}function getSelectedItemString(nodeId,nodeName){return'<span class="label label-primary" data-role="htree-item">'+nodeName+'<i class="window_close" data-role="htree-delete-item" data-node-id="'+nodeId+'"></i></span>'}function generateList(title,nodes,options){var nodeId,nd,s='<div class="node-selection-tree-column thin-scroll" data-role="htree-list"><h5 class="column-name '+(title||"none")+'">'+(title||"")+"</h5><ul>";for(nodeId in nodes)nd=nodes[nodeId],s+=getNodeString(nd,options);return s+="</ul></div>",$(s)}function getNodeString(node,options){var icon,cls,s,mutiSelect=options.mutiSelect,render=options.nodeRender;return cls=node.isIndeterminate?CSS_INDETERMINATE:node.selected?CSS_CHECKED:CSS_OUTLINE,icon=options.lazyLoadMode&&node.isLazy===!0?node.blurryIcon:0===node.getChildCount()?node.leafIcon:node.foldedIcon,s='<li data-node-id="'+node.id+'"><i class="'+cls+" "+(mutiSelect?"":"none")+'" data-role="htree-checkbox"></i>',options.lazyLoadMode===!0&&(s+='<img src="'+options.loadingAni+'" class="rounded m-l-xs m-r-xs none" data-role="htree-loading" width="14px" height="14px"/>'),s+=isImgIcon(icon)?'<img src="'+icon+'" class="rounded m-l-xs m-r-xs" data-role="htree-icon" width="14px" height="14px"/>':'<i class="'+icon+'" data-role="htree-icon"></i>',s+=$.isFunction(render)===!1?'<label data-role="htree-label" title="'+node.name+'">'+node.name+"</label></li>":render(node.getState())+"</li>"}function generateResultItem(inst,node){var checkIcon,itemIcon,ancestors,i,nd,s,options=inst.options,render=options.nodeRender;for(node.selected?(checkIcon=node.isIndeterminate?CSS_INDETERMINATE:CSS_CHECKED,itemIcon=node.expandedIcon||options.expandedIcon):(checkIcon=CSS_OUTLINE,itemIcon=node.foldedIcon||options.foldedIcon),s='<li><div class="result-name" data-node-id="'+node.id+'"><i class="'+checkIcon+" "+(options.mutiSelect?"":"none")+'" data-role="htree-result-checkbox"></i>',s+=$.isFunction(render)?render(node.getState())+"</div>":'<i class="'+itemIcon+'"></i><label for="" class="text-c-c">'+node.name+"</label></div>",ancestors=inst._getAncestorsById(node.id),s+='<div class="result-route">',i=ancestors.length-1;i>=0;i--)nd=ancestors[i],s+='<a href="javascript:void(0)" data-role="htree-link" data-node-id="'+nd.id+'">'+nd.name+"</a>",i>0&&(s+='<i class="chevron_right"></i>');return s+="</div></li>",$(s)}var $=jQuery,CSS_OUTLINE="check_box_outline_blank",CSS_CHECKED="check_box",CSS_INDETERMINATE="indeterminate_check_box",CSS_ACTIVE="active",CSS_CNTR="node-selection",FOLDER_ICON="folder",FOLDER_BLURRY_ICON="folder_move",FILE_ICON="file_outline",LOADING_ANI="loading.gif";$.ae.lang.aeHTree={selectedCount:"You have selected ? items",select:"Select",cancel:"Cancel"},HTreeNode.prototype={getChildCount:function(){return null!==this.childInfo.children?this.childInfo.children.length:0},gc:function(){var children=this.childInfo.children;null!==children&&children.splice(0,children.length),this.childInfo=null,this.userData=null},isRoot:function(){return null===this.pid},getState:function(){var i,count,state={id:this.id,pid:this.pid,selected:this.selected,isIndeterminate:this.isIndeterminate,userData:this.userData,isLazy:this.isLazy,rootId:this.rootId,children:[]},children=this.childInfo.children;if(children)for(i=0,count=children.length;count>i;i++)state.children.push(children[i].id);return state},each:function(nodes,callback,noRelativeAncestors,noRelativeDescendants){var i,nd,children=this.childInfo.children;if(callback.call(this,nodes),!noRelativeAncestors)for(nd=this,nd=nodes[nd.pid];nd;)nd.each(nodes,callback,noRelativeAncestors,noRelativeDescendants),nd=nodes[nd.pid];if(!noRelativeDescendants&&null!==children)for(i=children.length-1;i>=0;i--)children[i].each(nodes,callback,noRelativeAncestors,noRelativeDescendants)},setSelected:function(nodes,levels,selected,noRelativeAncestors,noRelativeDescendants){var nd,children,i,count,changed,state,ancestorSelected,ancestorIndeterminate,factor,affectedNodes=[],affectedChildNodes=[],boolSelected=!!selected;if(this.selected!==boolSelected){if(factor=boolSelected?1:-1,this.selected=boolSelected,this.isIndeterminate=!1,affectedNodes.push(this),levels[this.level].selectedCount+=factor,this.isRoot()===!1&&(nd=nodes[this.pid],nd.childInfo.selectedCount+=factor,!noRelativeAncestors))for(;nd;)changed=!1,state=getCheckCSS(nd.childInfo),ancestorSelected=state!==CSS_OUTLINE,ancestorIndeterminate=state===CSS_INDETERMINATE,factor=ancestorSelected?1:-1,nd.selected!==ancestorSelected&&(changed=!0,nd.selected=ancestorSelected,levels[nd.level].selectedCount+=factor,nodes[nd.pid]&&(nodes[nd.pid].childInfo.selectedCount+=factor)),nd.isIndeterminate!==ancestorIndeterminate&&(changed=!0,nd.isIndeterminate=ancestorIndeterminate),changed&&affectedNodes.push(nd),nd=nodes[nd.pid];if(children=this.childInfo.children,!noRelativeDescendants&&children)for(i=0,count=children.length;count>i;i++)affectedChildNodes=children[i].setSelected(nodes,levels,boolSelected,!0),affectedNodes=affectedNodes.concat(affectedChildNodes)}return affectedNodes}},$.aeWidget("ae.aeHTree",{options:{foldedIcon:FOLDER_ICON,expandedIcon:FOLDER_ICON,leafIcon:FILE_ICON,blurryIcon:FOLDER_BLURRY_ICON,loadingAni:LOADING_ANI,nodeRender:null,searchable:!0,mutiSelect:!1,mutiSelectMode:0,minLength:1,delay:300,footerEnabled:!0,source:null,lazyLoadMode:!1,subTreeId:null,ok:null,cancel:null,select:null,beforeCheck:null,beforeUnCheck:null,beforeDeleteNode:null,afterDeleteNode:null,check:null,unCheck:null},_create:function(){var source,cb,$el=this.element,opts=this.options,aeInit=$el.attr("aeInit");aeInit&&$el.data("org_aeInit",aeInit).attr("aeInit",!1),$el.attr("aeId",$el.attr("id")).addClass(CSS_CNTR).addClass("pos-rlt"),this._hdTimer=null,this._roots={},this._nodes={},this._levels=[],this._selectedNodes={},this._selectedCount=0,$el.append(generateSkeleton()),this._$input=$el.find('[data-role="htree-search"]'),this._$tree=$el.find('[data-role="htree-tree"]'),this._$result=$el.find('[data-role="htree-result"]'),this._$main=$el.find('[data-role="htree-main-list"]'),this._$sub=$el.find('[data-role="htree-sub-list"]'),this._$footer=$el.find('[data-role="htree-footer"]'),cb=$.proxy(function(){return this._$footer.find('[data-role="htree-popover"]').html()},this),this._$footer.find('[date-role="htree-count"]').popover({html:!0,placement:"top",title:"",content:cb}).on("show.bs.popover",this,function(event){var inst=event.data;return inst.options.disabled||0===inst._selectedCount?!1:void 0}),this._addEvents(),opts.searchable===!1?(opts.searchable=!opts.searchable,
this._setOption("searchable",!opts.searchable)):this._addSearchbarEvents(),opts.footerEnabled===!1?(opts.footerEnabled=!opts.footerEnabled,this._setOption("footerEnabled",!opts.footerEnabled)):(this.options.mutiSelect===!0?this._$footer.find('[data-role="htree-tips"]').show():this._$footer.find('[data-role="htree-tips"]').hide(),this._addFooterEvents()),null!==opts.source&&(source=opts.source,opts.source=null,this._setOption("source",source)),this.reset()},_refreshResults:function(){var value,nodes;this._$result.empty(),value=this._$input.val(),""===value?(this.element.find('[data-role="htree-search-clear"]').hide(),this._$tree.show(),this._$result.hide()):(value.length>=this.options.minLength&&(nodes=this._search(value),nodes.length>0&&this._reloadResult(nodes)),this._$tree.hide(),this._$result.show())},_addEvents:function(){this.element.find('[data-role="htree-tree"]').on("click.aeHTree","li",this,function(event){var inst=event.data,nodeId=$(this).attr("data-node-id");hdSelect.apply(this,[inst,nodeId]),inst._trigger("select",null,inst._nodes[nodeId].getState())}).on("click.aeHTree",'[data-role="htree-checkbox"]',this,function(event){var i,count,affectedNodes,affectedNodeStates,inst=event.data,$this=$(this),nodeId=$this.parent().attr("data-node-id"),selected=$this.hasClass(CSS_OUTLINE);if(inst._trigger(selected?"beforeCheck":"beforeUnCheck",null,inst._nodes[nodeId].getState())===!1)return event.stopPropagation(),!1;if(affectedNodes=hdCheck.apply(this,[inst,nodeId]),count=affectedNodes.length,count>0){for(affectedNodeStates=[],i=0;count>i;i++)affectedNodeStates.push(affectedNodes[i].getState());inst._$footer.find('[date-role="htree-count"]').popover("hide"),inst._trigger(selected?"check":"unCheck",null,affectedNodeStates)}event.stopPropagation()})},_delEvents:function(){this.element.find('[data-role="htree-tree"]').off(".aeHTree")},_addFooterEvents:function(){this._$footer.on("click.aeHTree","button",this,function(event){var $this=$(this),inst=event.data;return"htree-ok"===$this.attr("data-role")?inst._trigger("ok",null,inst.getSelectedNodes()):inst._trigger("cancel"),!1}).on("click.aeHTree",'[data-role="htree-win-close"]',this,function(event){var inst=event.data;return inst._$footer.find('[date-role="htree-count"]').popover("hide"),$(this).parents(".popover").hide(),!1}).on("click.aeHTree",'[data-role="htree-delete-item"]',this,function(event){var $el,affectedNodes,$this=$(this),inst=event.data,mutiSelect=inst.options.mutiSelect,nodeId=$this.attr("data-node-id");if(!mutiSelect||inst._trigger("beforeUnCheck",null,inst._nodes[nodeId].getState())!==!1)return affectedNodes=inst.setSelected(nodeId,!1),$el=inst._$footer.find('[date-role="htree-count"]'),$el.popover("hide"),inst._updateSelectedNodes(affectedNodes),inst._selectedCount>0&&$el.popover("show"),mutiSelect&&(inst._$footer.find('[date-role="htree-count"]').popover("hide"),inst._trigger("unCheck",null,inst._nodes[nodeId].getState())),!1})},_delFooterEvents:function(){this._$footer.off(".aeHTree")},_addSearchbarEvents:function(){this.element.find('[data-role="htree-search-clear"]').on("click.aeHTree",this,function(event){var inst=event.data;null!==inst._hdTimer&&(clearTimeout(inst._hdTimer),inst._hdTimer=null),$(this).hide(),inst._$result.empty(),inst._$result.hide(),inst._$tree.show(),inst._$input.val("")[0].focus(),event.stopPropagation()}),this._$input.on("keyup.aeHTree",this,function(event){var inst=event.data;return null!==inst._hdTimer&&(clearTimeout(inst._hdTimer),inst._hdTimer=null),27===event.which?void $(this).trigger("blur.aeHtree",inst):(inst.element.find('[data-role="htree-search-clear"]').show(),void(inst._hdTimer=setTimeout($.proxy(inst._refreshResults,inst),inst.options.delay)))}).on("focus.aeHTree",this,function(event){var inst=event.data;inst._$result.has("i").length>0&&"none"===inst._$result.css("display")&&(inst._$tree.hide(),inst._$result.slideDown(200))}).on("blur.aeHTree",this,function(event){}),this._$result.on("click.aeHTree",'[data-role="htree-result-checkbox"]',this,function(event){var selected,$el,$chks,affectedNodes,affectedNodeStates,itemId,nd,cls,i,count,inst=event.data,$this=$(this),mutiSelect=inst.options.mutiSelect,nodes=inst._nodes,levels=inst._levels,nodeId=$this.parent().attr("data-node-id");if(nd=nodes[nodeId],selected=!nd.selected,mutiSelect&&inst._trigger(selected?"beforeCheck":"beforeUnCheck",null,nd.getState())===!1)return event.stopPropagation(),!1;if($el=inst._$tree.find('[data-node-id="'+nodeId+'"]>[data-role="htree-checkbox"]'),$el.length>0)affectedNodes=hdCheck.apply($el[0],[inst,nodeId]);else for(affectedNodes=nd.setSelected(nodes,levels,selected),inst._updateSelectedNodes(affectedNodes),i=affectedNodes.length-1;i>=0;i--)$el=inst._$tree.find('[data-node-id="'+affectedNodes[i].id+'"]'),$el.length>0&&(cls=affectedNodes[i].isIndeterminate?CSS_INDETERMINATE:affectedNodes[i].selected?CSS_CHECKED:CSS_OUTLINE,$el.find('[data-role="htree-checkbox"]').removeClass().addClass(cls));for($chks=inst._$result.find('[data-role="htree-result-checkbox"]'),i=$chks.length-1;i>=0;i--)$el=$($chks[i]),$el.removeClass(),itemId=$el.parent().attr("data-node-id"),nodes[itemId].isIndeterminate?$el.addClass(CSS_INDETERMINATE):$el.addClass(nodes[itemId].selected?CSS_CHECKED:CSS_OUTLINE);if(count=affectedNodes.length,count>0){for(affectedNodeStates=[],i=0;count>i;i++)affectedNodeStates.push(affectedNodes[i].getState());inst._$footer.find('[date-role="htree-count"]').popover("hide"),inst._trigger(selected?"check":"unCheck",null,affectedNodeStates)}}).on("click.aeHTree","a",this,function(event){var nodeId,$this=$(this),inst=event.data;"htree-link"===$this.attr("data-role")&&(nodeId=$this.attr("data-node-id"),inst["goto"](nodeId),inst._$result.hide(),inst._$tree.show())})},_delSearchbarEvents:function(){this._$input.off(".aeHTree"),this._$result.off(".aeHTree"),this.element.find('[data-role="htree-search-clear"]').off(".aeHTree")},_updateSelectedNodes:function(nodes,isClear){var nd,nodeId,i,count,isExisted,$el,selectedNodes=this._selectedNodes;if(isClear===!0)for(i=0,count=nodes.length;count>i;i++)nd=nodes[i],nd.id in selectedNodes&&(delete selectedNodes[nd.id],this._selectedCount--);else for($el=this._$footer.find('[data-role="htree-popover"]'),i=0,count=nodes.length;count>i;i++)nd=nodes[i],nodeId=nd.id,isExisted=nodeId in selectedNodes,nd.selected===!0&&isExisted===!1?(selectedNodes[nodeId]=nd,this._selectedCount++,0===$el.find('[data-node-id="'+nodeId+'"]').length&&$el.append(getSelectedItemString(nodeId,nd.name))):nd.selected===!0&&isExisted===!0?0===$el.find('[data-node-id="'+nodeId+'"]').length&&$el.append(getSelectedItemString(nodeId,nd.name)):nd.selected===!1&&isExisted===!0&&(delete selectedNodes[nodeId],this._selectedCount--,$el.find('[data-node-id="'+nodeId+'"]').parent().remove());this._$footer.find('[date-role="htree-count"]').text(""+this._selectedCount)},_clearSelectedList:function(){var nodeId,selectedNodes=this._selectedNodes;for(nodeId in selectedNodes)delete selectedNodes[nodeId];this._selectedCount=0,this._$footer.find('[data-role="htree-popover"]').empty()},_search:function(condition){var nodeId,nd,nodes=this._nodes,arr=[];for(nodeId in nodes)nd=nodes[nodeId],nd.name.indexOf(condition)>=0&&arr.push(nd);return arr},_reloadResult:function(nodes){var nd,i,$result=this._$result,count=nodes.length;for($result.empty(),i=0;count>i;i++)nd=nodes[i],$result.append(generateResultItem(this,nd))},"goto":function(nodeId){var nd,$el,ancestors,ancestorId,i,$tree;if(nodeId in this._nodes){for(nd=this._nodes[nodeId],$el=this._$tree.find('[data-node-id="'+nodeId+'"]'),$tree=this._$tree,ancestors=this._getAncestorsById(nodeId),i=ancestors.length-1;i>=0;i--)ancestorId=ancestors[i].id,$el=$tree.find('[data-node-id="'+ancestorId+'"]'),hdSelect.apply($el[0],[this,ancestorId]);return this._$sub.scrollLeft($el.position().left),!0}return!1},getSelectedCount:function(){return this.options.mutiSelect===!0?this._selectedCount:this._$tree.find("."+CSS_ACTIVE).length>0?1:void 0},_setSelected:function(nodeId,selected,noRelativeAncestors,noRelativeDescendants){var $chk,ancestors,nd,icon,$chkList,$el,isRoot,i,count;if(nodeId in this._nodes&&(nd=this._nodes[nodeId],isRoot=nd.isRoot(),$el=this._$tree.find('[data-node-id="'+nodeId+'"]'),$chk=$el.find('[data-role="htree-checkbox"]'),selected?$chk.removeClass(CSS_OUTLINE).addClass(CSS_CHECKED):$chk.removeClass().addClass(CSS_OUTLINE),noRelativeDescendants===!1&&nd.getChildCount()>0&&$el.hasClass(CSS_ACTIVE)&&(icon=nd.selected?CSS_CHECKED:CSS_OUTLINE,$chkList=isRoot?this._$sub.find('[data-role="htree-checkbox"]'):this._$sub.find('[data-node-id="'+nodeId+'"]').parents('[data-role="htree-list"]:eq(0)').nextAll().find('[data-role="htree-checkbox"]'),$chkList.removeClass().addClass(icon)),noRelativeAncestors===!1&&isRoot===!1))for(ancestors=this._getAncestorsById(nodeId),count=ancestors.length,i=1;count>i;i++)icon=getCheckCSS(ancestors[i].childInfo),$chkList=ancestors[i].isRoot()?this._$main:this._$sub,$chkList.find('[data-node-id="'+ancestors[i].id+'"]>[data-role="htree-checkbox"]').removeClass().addClass(icon)},setSelected:function(nodeId,selected){var relativeFlags,mutiSelect=this.options.mutiSelect,affectedNodes=[];return this["goto"](nodeId),mutiSelect===!0&&(relativeFlags=getRelativeFlags(this.options.mutiSelectMode),affectedNodes=this._nodes[nodeId].setSelected(this._nodes,this._levels,selected,relativeFlags.noRelativeAncestors,relativeFlags.noRelativeDescendants),this._setSelected(nodeId,selected,relativeFlags.noRelativeAncestors,relativeFlags.noRelativeDescendants)),affectedNodes},_initData:function(data){var i,nd,css,factor,isSelected,ndParent,pnds,cb,nodeId,count=data.length,expandedIcon=this.options.expandedIcon,foldedIcon=this.options.foldedIcon,leafIcon=this.options.leafIcon,blurryIcon=this.options.blurryIcon,lazyLoadMode=this.options.lazyLoadMode,mutiSelectMode=this.options.mutiSelectMode,nodes=this._nodes,roots=this._roots,levels=this._levels,selectedNodes=this._selectedNodes;for(i=0;count>i;i++)nd=new HTreeNode({id:data[i].id,pid:data[i].pid,name:data[i].name,expandedIcon:data[i].expandedIcon||expandedIcon,foldedIcon:data[i].foldedIcon||foldedIcon,leafIcon:data[i].leafIcon||leafIcon,blurryIcon:data[i].blurryIcon||blurryIcon,selected:!!data[i].selected,userData:data[i].userData}),lazyLoadMode===!0&&data[i].isLazy===!1&&(nd.isLazy=!1),nodes[nd.id]=nd,nd.isRoot()&&(roots[nd.id]=nd,nd.rootId=nd.id);for(nodeId in nodes)nd=nodes[nodeId],null!==nd.pid?(ndParent=nodes[nd.pid],null===ndParent.childInfo.children&&(ndParent.childInfo.children=[]),ndParent.childInfo.children.push(nd),nd.selected&&(ndParent.childInfo.selectedCount++,selectedNodes[nd.id]=nd,this._selectedCount++)):nd.selected&&(selectedNodes[nd.id]=nd,this._selectedCount++);cb=function(nds){var levelInfo;this.isRoot()===!1&&(this.level=nds[this.pid].level+1,this.rootId=nds[this.pid].rootId),levelInfo=levels[this.level],levelInfo||(levelInfo=levels[this.level]={selectedCount:0,count:0,parents:{}}),this.selected&&levelInfo.selectedCount++,levelInfo.count++,null!==this.pid&&(levelInfo.parents[this.pid]=nodes[this.pid])};for(nodeId in roots)roots[nodeId].each(nodes,cb,!0);if(0===mutiSelectMode||2===mutiSelectMode)for(i=levels.length-1;i>=1;i--){pnds=levels[i].parents;for(nodeId in pnds)nd=pnds[nodeId],levelInfo=levels[nd.level],css=getCheckCSS(nd.childInfo),nd.isIndeterminate=css===CSS_INDETERMINATE,isSelected=css!==CSS_OUTLINE,nd.selected!==isSelected&&(nd.selected=isSelected,isSelected?(factor=1,selectedNodes[nd.id]=nd):(factor=-1,delete selectedNodes[nd.id]),null!==nd.pid&&(nodes[nd.pid].childInfo.selectedCount+=factor),this._selectedCount+=factor,levelInfo.selectedCount+=factor)}this._filterSubTree()},_filterSubTree:function(){var cache,nodes,roots,levels,selectedNodes,oldRootId,newRootId,cb,levelInfo,nodeId,subTreeId=this.options.subTreeId,self=this;if(null!==subTreeId&&subTreeId in this._nodes){cache={};for(nodeId in this._nodes)cache[nodeId]=this._nodes[nodeId];nodes=this._nodes={},roots=this._roots={},levels=this._levels=[],selectedNodes=this._selectedNodes={},self._selectedCount=0,oldRootId=cache[subTreeId].rootId,newRootId=cache[subTreeId].id,cb=function(nodeSet){this.rootId==oldRootId&&(nodes[this.id]=this,this.isRoot()===!1&&(this.level=nodeSet[this.pid].level+1,this.rootId=newRootId),levelInfo=levels[this.level],levelInfo||(levelInfo=levels[this.level]={selectedCount:0,count:0,parents:{}}),levelInfo.count++,this.selected&&(levelInfo.selectedCount++,selectedNodes[this.id]=this,self._selectedCount++),null!==this.pid&&(levelInfo.parents[this.pid]=nodeSet[this.pid]))},cache[subTreeId].pid=null,cache[subTreeId].level=0,cache[subTreeId].each(cache,cb,!0),cache[subTreeId].rootId=cache[subTreeId].id,roots[subTreeId]=cache[subTreeId]}},_setOptions:function(options){var opts,prevDisabled=this.options.disabled;this._super(options),opts=this.options,prevDisabled!==opts.disabled&&(opts.disabled?(this.element.find('[data-role="htree-search-clear"]').trigger("click.aeHTree",this),this._delEvents(),this._delSearchbarEvents(),this._delFooterEvents(),this._$input.prop("disabled",!0).addClass("bg-gray"),this._$footer.find('[data-role="htree-cancel"],[data-role="htree-ok"]').prop("disabled",!0),this._$footer.find('[data-role="htree-tips"]').addClass("text-muted").find("a").removeClass("text-primary").addClass("text-muted")):(this._$input.prop("disabled",!1).removeClass("bg-gray"),this._$footer.find('[data-role="htree-cancel"],[data-role="htree-ok"]').prop("disabled",!1),this._$footer.find('[data-role="htree-tips"]').removeClass("text-muted").find("a").removeClass("text-muted").addClass("text-primary"),this._addEvents(),opts.searchable&&this._addSearchbarEvents(),opts.footerEnabled&&this._addFooterEvents()))},_setOption:function(key,value){var $el,nodeId,affectedNodes;if(this.options[key]!==value)switch(this._super(key,value),key){case"searchable":$el=this.element.find('[data-role="htree-search-bar"]'),value?(this._addSearchbarEvents(),$el.show(),this._$tree.css("padding-top","auto")):(this._$result.hide(),this._$tree.show(),$el.hide(),this._delSearchbarEvents(),this._$tree.css("padding-top",0));break;case"mutiSelect":if($el=this.element.find('[data-role="htree-checkbox"]'),value)nodeId=$el.filter(":last").parent().attr("data-node-id"),nodeId&&(affectedNodes=this._nodes[nodeId].setSelected(this._nodes,this._levels,!1)),this._$footer.find('[data-role="htree-tips"]').show(),$el.show();else{$el.removeClass().addClass(CSS_OUTLINE);for(nodeId in this._roots)affectedNodes=this._roots[nodeId].setSelected(this._nodes,this._levels,!1);this._$footer.find('[data-role="htree-tips"]').hide(),$el.hide()}break;case"source":$.isArray(value)?this.reload(value):$.isFunction(value)&&this.reload(value.call(this.element,null));break;case"footerEnabled":value?(this._addFooterEvents(),this.options.mutiSelect===!0?this._$footer.find('[data-role="htree-tips"]').show():this._$footer.find('[data-role="htree-tips"]').hide(),this._$footer.show(),this._$tree.css("padding-bottom","auto")):(this._delFooterEvents(),this._$footer.hide(),this._$tree.css("padding-bottom",0));break;case"minLength":$.isNumeric(value)?this.options.minLength=1>value?1:parseInt(vlaue,10):this.options.minLength=1}},addLazyChilds:function(parentId,serviceName,params,convertor){return this.options.lazyLoadMode!==!1&&parentId in this._nodes&&this._nodes[parentId].isLazy!==!1?($.ajaxPost(serviceName,params,$.proxy(function(data){var item,i,count,$el,finalData=null,opts=this.options;if($.isArray(data)?finalData=data:$.isArray(data.rows)&&(finalData=data.rows),$.isFunction(convertor)&&null!==finalData)for(count=finalData.length,i=0;count>i;i++)item=convertor(finalData[i]),this.addNode({id:item.id,pid:parentId,name:item.name,expandedIcon:item.expandedIcon||opts.expandedIcon,foldedIcon:item.foldedIcon||opts.foldedIcon,leafIcon:item.leafIcon||opts.leafIcon,blurryIcon:item.blurryIcon||opts.blurryIcon,selected:!!item.selected,isLazy:!!item.isLazy,userData:item.userData||finalData[i]},parentId);$el=this._$tree.find('[data-node-id="'+parentId+'"]'),this._nodes[parentId].isLazy=!1,this._nodes[parentId].loading=!1,$el.find('[data-role="htree-icon"]').show().removeClass().addClass(this._nodes[parentId].expandedIcon),$el.find('[data-role="htree-loading"]').hide()},this),$.proxy(function(errCode,errInfo){$el=this._$tree.find('[data-node-id="'+parentId+'"]'),$el.find('[data-role="htree-icon"]').show(),$el.find('[data-role="htree-loading"]').hide(),this._nodes[parentId].loading=!1},this)),!0):!1},_checkState:function(nodeState){var b=!(nodeState.id in this._nodes)&&nodeState.id&&nodeState.name;return nodeState.pid&&(b=b&&nodeState.pid in this._nodes),!!b},addNode:function(nodeState){var levelInfo,childInfo,nd,$list,isRoot,nodes=this._nodes,levels=this._levels;return this._checkState(nodeState)===!0?(nd=new HTreeNode(nodeState,this.options),isRoot=null===nd.pid,nd.level=isRoot?0:nodes[nd.pid].level+1,levelInfo=levels[nd.level],levelInfo||(levelInfo=levels[nd.level]={selectedCount:0,count:0,parents:{}}),isRoot===!1&&(levelInfo.parents[nd.pid]=nodes[nd.pid],childInfo=nodes[nd.pid].childInfo,0===nodes[nd.pid].getChildCount()&&(childInfo.children=[]),childInfo.children.push(nd),nd.selected===!0&&(levelInfo.selectedCount++,childInfo.selectedCount++),this._updateAncestorNodesState(nodes[nd.pid])),nodes[nd.id]=nd,null===nd.pid?($list=this._$main.find('[data-role="htree-list"]:eq(0)'),$list.find("ul:eq(0)").append($(getNodeString(nd,this.options)))):this._refreshAssociationNodesView(nd),nd.selected&&this._updateSelectedNodes([nd]),!0):!1},_refreshAssociationNodesView:function(nd){var $el,$list,i,count,ancestors,opts=this.options,selector=(opts.lazyLoadMode,"."+CSS_ACTIVE);if($el=this._$tree.find('[data-node-id="'+nd.pid+'"]'),$el.length>0)$el.hasClass(CSS_ACTIVE)===!0?($list=null===this._nodes[nd.pid].pid?this._$sub.find('[data-role="htree-list"]:eq(0)'):$el.parents('[data-role="htree-list"]:eq(0)').next(),$list.length>0?$list.find("ul:eq(0)").append($(getNodeString(nd,opts))):this._$sub.append(generateList("",this._getChilrenById(nd.pid),this.options))):($el.addClass(CSS_ACTIVE).siblings(selector).removeClass(CSS_ACTIVE),$el.parents('[data-role="htree-list"]:eq(0)').next().remove(),this._$sub.append(generateList("",this._getChilrenById(nd.pid),this.options)));else for(ancestors=this._getAncestorsById(nd.pid),count=ancestors.length,i=0;count>i;i++)this._refreshNodeView(ancestors[i])},_updateAncestorNodesState:function(node){for(var nd=node,nodes=this._nodes;nd;)css=getCheckCSS(nd.childInfo),nd.isIndeterminate=css===CSS_INDETERMINATE,nd.selected=css!==CSS_OUTLINE,this._refreshNodeView(nd),nd=nodes[nd.pid]},_refreshNodeView:function(node){var $el,$label,icon,nodeId=node.id;$el=this._$tree.find('[data-node-id="'+nodeId+'"]'),$el.length>0&&(icon=this.options.lazyLoadMode&&node.isLazy===!0?node.blurryIcon:0===node.getChildCount()?node.leafIcon:node.foldedIcon,isImgIcon(icon)?$el.find('[data-role="htree-icon"]').attr("src",icon):$el.find('[data-role="htree-icon"]').removeClass().addClass(icon),this.options.mutiSelect===!0&&(node.isIndeterminate?$el.find('[data-role="htree-checkbox"]').removeClass().addClass(CSS_INDETERMINATE):$el.find('[data-role="htree-checkbox"]').removeClass().addClass(node.selected?CSS_CHECKED:CSS_OUTLINE)),$label=$el.find('[data-role="htree-label"]'),$label.text()!==node.name&&$label.text(node.name))},deleteNode:function(nodeId){var nd,deleteNodes,cb,levelInfo,nodes=this._nodes,levels=this._levels;this._selectedNodes;if(nodeId in nodes){if(this._trigger("beforeDeleteNode",null,nodes[nodeId].getState())===!1)return;nd=nodes[nodeId],this._deleteNodeView(nd),null!==nd.pid&&(nd=nodes[nd.pid],nd.childInfo.children=null,nd.childInfo.selectedCount=0,nd.isLazy=!1,nd.loading=!1),deleteNodes=[],cb=function(nodes){var nodeId=this.id;levelInfo=levels[this.level],this.selected===!0&&levelInfo.selectedCount--,nodeId in levelInfo.parents&&delete levelInfo.parents[nodeId],deleteNodes.push(this)},nd.each(nodes,cb,!0),this._updateSelectedNodes(deleteNodes,!0);for(i=deleteNodes.length-1;i>=0;i--)deleteNodes[i].gc(),delete nodes[deleteNodes[i].id];this._$footer.find('[date-role="htree-count"]').popover("hide"),this._trigger("afterDeleteNode")}},_deleteNodeView:function(node){var $el;node.isRoot()?(this._$main.find("[data-node-id='"+node.id+"']").remove(),node.selected===!0&&(this._$sub.empty(),this.reset())):($el=this._$sub.find("[data-node-id='"+node.id+"']"),$el.parents('[data-role="htree-list"]:eq(0)').nextAll().remove(),$el.remove())},setNodeText:function(nodeId,text){$.isFunction(this.options.nodeRender)||this._$tree.find('[data-node-id="'+nodeId+'"]').find("label").text(text)},clear:function(){var nodeId,i,parents,nodes=this._selectedNodes;for(null!==this._hdTimer&&(clearTimeout(this._hdTimer),this._hdTimer=null),this.element.find('[data-role="htree-search-clear"]').trigger("click.aeHTree",this),i=this._levels.length-1;i>=0;i--){parents=this._levels.parents;for(nodeId in parents)delete parents[nodeId]}this._levels.splice(0,this._levels.length),this._$input.val(""),this._$result.empty().hide(),this._$tree.show(),this._$main.empty(),this._$sub.empty();for(nodeId in nodes)delete nodes[nodeId];this._selectedCount=0,nodes=this._roots;for(nodeId in nodes)delete nodes[nodeId];nodes=this._nodes;for(nodeId in nodes)nodes[nodeId].gc(),delete nodes[nodeId]},_reloadRootList:function(){this._$main.append(generateList("",this._roots,this.options))},reload:function(data){var nodes,nodeId,arr;if(this.clear(),$.isArray(data)===!0){this._initData(data),this._reloadRootList(),arr=[],nodes=this._selectedNodes;for(nodeId in nodes)arr.push(nodes[nodeId]);arr.length>0&&this._updateSelectedNodes(arr)}},getNodeById:function(nodeId){return nodeId in this._nodes?this._nodes[nodeId].getState():null},reset:function(){var nodeId=this._$main.find("[data-node-id]:eq(0)").attr("data-node-id");this["goto"](nodeId)},getSelectedNodes:function(){var nodeId,nodes,$el,arr=[];if(this.options.mutiSelect===!0){nodes=this._selectedNodes;for(nodeId in nodes)arr.push(nodes[nodeId].getState())}else $el=this._$tree.find("."+CSS_ACTIVE).filter(":last"),$el.length>0&&(nodeId=$el.attr("data-node-id"),arr.push(this._nodes[nodeId].getState()));return arr},_getAncestorsById:function(nodeId,isSelected,isObverse){var nodes=this._nodes,nd=nodes[nodeId],arr=[];if(isSelected)for(;nd;)nd.selected&&arr.push(nd),nd=nodes[nd.pid];else for(;nd;)arr.push(nd),nd=nodes[nd.pid];return isObverse?arr.reverse():arr},getAncestorsById:function(nodeId,isSelected,isObverse){var i,nodes=this._getAncestorsById(nodeId,isSelected,isObverse),count=nodes.length;for(i=0;count>i;i++)nodes[i]=nodes[i].getState();return nodes},_getChilrenById:function(nodeId,isSelected){var children,i,count,nd=this._nodes[nodeId],obj={};if(nd.getChildCount()>0)if(children=nd.childInfo.children,isSelected)for(i=0,count=children.length;count>i;i++)children[i].selected&&(obj[children[i].id]=children[i]);else for(i=0,count=children.length;count>i;i++)obj[children[i].id]=children[i];return obj},getChilrenById:function(nodeId,isSelected){var id,nodes=this._getChilrenById(nodeId,isSelected),arr=[];for(id in nodes)arr.push(nodes[id].getState());return arr},_destroy:function(){var $el=this.element,aeInit=$el.data("org_aeInit");this.clear(),aeInit&&$el.attr("aeInit",aeInit),$el.removeAttr("aeId").removeClass(CSS_CNTR),this._selectedNodes=null,this._roots=null,this._nodes=null,this._levels=null,this._$input=null,this._$result=null,this._$main=null,this._$sub=null,this._$tree=null}})}),function(a){function b(a,b,c){switch(arguments.length){case 2:return null!=a?a:b;case 3:return null!=a?a:null!=b?b:c;default:throw new Error("Implement me")}}function c(a,b){return zb.call(a,b)}function d(){return{empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1}}function e(a){tb.suppressDeprecationWarnings===!1&&"undefined"!=typeof console&&console.warn&&console.warn("Deprecation warning: "+a)}function f(a,b){var c=!0;return m(function(){return c&&(e(a),c=!1),b.apply(this,arguments)},b)}function g(a,b){qc[a]||(e(b),qc[a]=!0)}function h(a,b){return function(c){return p(a.call(this,c),b)}}function i(a,b){return function(c){return this.localeData().ordinal(a.call(this,c),b)}}function j(){}function k(a,b){b!==!1&&F(a),n(this,a),this._d=new Date(+a._d)}function l(a){var b=y(a),c=b.year||0,d=b.quarter||0,e=b.month||0,f=b.week||0,g=b.day||0,h=b.hour||0,i=b.minute||0,j=b.second||0,k=b.millisecond||0;this._milliseconds=+k+1e3*j+6e4*i+36e5*h,this._days=+g+7*f,this._months=+e+3*d+12*c,this._data={},this._locale=tb.localeData(),this._bubble()}function m(a,b){for(var d in b)c(b,d)&&(a[d]=b[d]);return c(b,"toString")&&(a.toString=b.toString),c(b,"valueOf")&&(a.valueOf=b.valueOf),a}function n(a,b){var c,d,e;if("undefined"!=typeof b._isAMomentObject&&(a._isAMomentObject=b._isAMomentObject),"undefined"!=typeof b._i&&(a._i=b._i),"undefined"!=typeof b._f&&(a._f=b._f),"undefined"!=typeof b._l&&(a._l=b._l),"undefined"!=typeof b._strict&&(a._strict=b._strict),"undefined"!=typeof b._tzm&&(a._tzm=b._tzm),"undefined"!=typeof b._isUTC&&(a._isUTC=b._isUTC),"undefined"!=typeof b._offset&&(a._offset=b._offset),"undefined"!=typeof b._pf&&(a._pf=b._pf),"undefined"!=typeof b._locale&&(a._locale=b._locale),Ib.length>0)for(c in Ib)d=Ib[c],e=b[d],"undefined"!=typeof e&&(a[d]=e);return a}function o(a){return 0>a?Math.ceil(a):Math.floor(a)}function p(a,b,c){for(var d=""+Math.abs(a),e=a>=0;d.length<b;)d="0"+d;return(e?c?"+":"":"-")+d}function q(a,b){var c={milliseconds:0,months:0};return c.months=b.month()-a.month()+12*(b.year()-a.year()),a.clone().add(c.months,"M").isAfter(b)&&--c.months,c.milliseconds=+b-+a.clone().add(c.months,"M"),c}function r(a,b){var c;return b=K(b,a),a.isBefore(b)?c=q(a,b):(c=q(b,a),c.milliseconds=-c.milliseconds,c.months=-c.months),c}function s(a,b){return function(c,d){var e,f;return null===d||isNaN(+d)||(g(b,"moment()."+b+"(period, number) is deprecated. Please use moment()."+b+"(number, period)."),f=c,c=d,d=f),c="string"==typeof c?+c:c,e=tb.duration(c,d),t(this,e,a),this}}function t(a,b,c,d){var e=b._milliseconds,f=b._days,g=b._months;d=null==d?!0:d,e&&a._d.setTime(+a._d+e*c),f&&nb(a,"Date",mb(a,"Date")+f*c),g&&lb(a,mb(a,"Month")+g*c),d&&tb.updateOffset(a,f||g)}function u(a){return"[object Array]"===Object.prototype.toString.call(a)}function v(a){return"[object Date]"===Object.prototype.toString.call(a)||a instanceof Date}function w(a,b,c){var d,e=Math.min(a.length,b.length),f=Math.abs(a.length-b.length),g=0;for(d=0;e>d;d++)(c&&a[d]!==b[d]||!c&&A(a[d])!==A(b[d]))&&g++;return g+f}function x(a){if(a){var b=a.toLowerCase().replace(/(.)s$/,"$1");a=jc[a]||kc[b]||b}return a}function y(a){var b,d,e={};for(d in a)c(a,d)&&(b=x(d),b&&(e[b]=a[d]));return e}function z(b){var c,d;if(0===b.indexOf("week"))c=7,d="day";else{if(0!==b.indexOf("month"))return;c=12,d="month"}tb[b]=function(e,f){var g,h,i=tb._locale[b],j=[];if("number"==typeof e&&(f=e,e=a),h=function(a){var b=tb().utc().set(d,a);return i.call(tb._locale,b,e||"")},null!=f)return h(f);for(g=0;c>g;g++)j.push(h(g));return j}}function A(a){var b=+a,c=0;return 0!==b&&isFinite(b)&&(c=b>=0?Math.floor(b):Math.ceil(b)),c}function B(a,b){return new Date(Date.UTC(a,b+1,0)).getUTCDate()}function C(a,b,c){return hb(tb([a,11,31+b-c]),b,c).week}function D(a){return E(a)?366:365}function E(a){return a%4===0&&a%100!==0||a%400===0}function F(a){var b;a._a&&-2===a._pf.overflow&&(b=a._a[Bb]<0||a._a[Bb]>11?Bb:a._a[Cb]<1||a._a[Cb]>B(a._a[Ab],a._a[Bb])?Cb:a._a[Db]<0||a._a[Db]>24||24===a._a[Db]&&(0!==a._a[Eb]||0!==a._a[Fb]||0!==a._a[Gb])?Db:a._a[Eb]<0||a._a[Eb]>59?Eb:a._a[Fb]<0||a._a[Fb]>59?Fb:a._a[Gb]<0||a._a[Gb]>999?Gb:-1,a._pf._overflowDayOfYear&&(Ab>b||b>Cb)&&(b=Cb),a._pf.overflow=b)}function G(b){return null==b._isValid&&(b._isValid=!isNaN(b._d.getTime())&&b._pf.overflow<0&&!b._pf.empty&&!b._pf.invalidMonth&&!b._pf.nullInput&&!b._pf.invalidFormat&&!b._pf.userInvalidated,b._strict&&(b._isValid=b._isValid&&0===b._pf.charsLeftOver&&0===b._pf.unusedTokens.length&&b._pf.bigHour===a)),b._isValid}function H(a){return a?a.toLowerCase().replace("_","-"):a}function I(a){for(var b,c,d,e,f=0;f<a.length;){for(e=H(a[f]).split("-"),b=e.length,c=H(a[f+1]),c=c?c.split("-"):null;b>0;){if(d=J(e.slice(0,b).join("-")))return d;if(c&&c.length>=b&&w(e,c,!0)>=b-1)break;b--}f++}return null}function J(a){var b=null;if(!Hb[a]&&Jb)try{b=tb.locale(),require("./locale/"+a),tb.locale(b)}catch(c){}return Hb[a]}function K(a,b){var c,d;return b._isUTC?(c=b.clone(),d=(tb.isMoment(a)||v(a)?+a:+tb(a))-+c,c._d.setTime(+c._d+d),tb.updateOffset(c,!1),c):tb(a).local()}function L(a){return a.match(/\[[\s\S]/)?a.replace(/^\[|\]$/g,""):a.replace(/\\/g,"")}function M(a){var b,c,d=a.match(Nb);for(b=0,c=d.length;c>b;b++)d[b]=pc[d[b]]?pc[d[b]]:L(d[b]);return function(e){var f="";for(b=0;c>b;b++)f+=d[b]instanceof Function?d[b].call(e,a):d[b];return f}}function N(a,b){return a.isValid()?(b=O(b,a.localeData()),lc[b]||(lc[b]=M(b)),lc[b](a)):a.localeData().invalidDate()}function O(a,b){function c(a){return b.longDateFormat(a)||a}var d=5;for(Ob.lastIndex=0;d>=0&&Ob.test(a);)a=a.replace(Ob,c),Ob.lastIndex=0,d-=1;return a}function P(a,b){var c,d=b._strict;switch(a){case"Q":return Zb;case"DDDD":return _b;case"YYYY":case"GGGG":case"gggg":return d?ac:Rb;case"Y":case"G":case"g":return cc;case"YYYYYY":case"YYYYY":case"GGGGG":case"ggggg":return d?bc:Sb;case"S":if(d)return Zb;case"SS":if(d)return $b;case"SSS":if(d)return _b;case"DDD":return Qb;case"MMM":case"MMMM":case"dd":case"ddd":case"dddd":return Ub;case"a":case"A":return b._locale._meridiemParse;case"x":return Xb;case"X":return Yb;case"Z":case"ZZ":return Vb;case"T":return Wb;case"SSSS":return Tb;case"MM":case"DD":case"YY":case"GG":case"gg":case"HH":case"hh":case"mm":case"ss":case"ww":case"WW":return d?$b:Pb;case"M":case"D":case"d":case"H":case"h":case"m":case"s":case"w":case"W":case"e":case"E":return Pb;case"Do":return d?b._locale._ordinalParse:b._locale._ordinalParseLenient;default:return c=new RegExp(Y(X(a.replace("\\","")),"i"))}}function Q(a){a=a||"";var b=a.match(Vb)||[],c=b[b.length-1]||[],d=(c+"").match(hc)||["-",0,0],e=+(60*d[1])+A(d[2]);return"+"===d[0]?-e:e}function R(a,b,c){var d,e=c._a;switch(a){case"Q":null!=b&&(e[Bb]=3*(A(b)-1));break;case"M":case"MM":null!=b&&(e[Bb]=A(b)-1);break;case"MMM":case"MMMM":d=c._locale.monthsParse(b,a,c._strict),null!=d?e[Bb]=d:c._pf.invalidMonth=b;break;case"D":case"DD":null!=b&&(e[Cb]=A(b));break;case"Do":null!=b&&(e[Cb]=A(parseInt(b.match(/\d{1,2}/)[0],10)));break;case"DDD":case"DDDD":null!=b&&(c._dayOfYear=A(b));break;case"YY":e[Ab]=tb.parseTwoDigitYear(b);break;case"YYYY":case"YYYYY":case"YYYYYY":e[Ab]=A(b);break;case"a":case"A":c._isPm=c._locale.isPM(b);break;case"h":case"hh":c._pf.bigHour=!0;case"H":case"HH":e[Db]=A(b);break;case"m":case"mm":e[Eb]=A(b);break;case"s":case"ss":e[Fb]=A(b);break;case"S":case"SS":case"SSS":case"SSSS":e[Gb]=A(1e3*("0."+b));break;case"x":c._d=new Date(A(b));break;case"X":c._d=new Date(1e3*parseFloat(b));break;case"Z":case"ZZ":c._useUTC=!0,c._tzm=Q(b);break;case"dd":case"ddd":case"dddd":d=c._locale.weekdaysParse(b),null!=d?(c._w=c._w||{},c._w.d=d):c._pf.invalidWeekday=b;break;case"w":case"ww":case"W":case"WW":case"d":case"e":case"E":a=a.substr(0,1);case"gggg":case"GGGG":case"GGGGG":a=a.substr(0,2),b&&(c._w=c._w||{},c._w[a]=A(b));break;case"gg":case"GG":c._w=c._w||{},c._w[a]=tb.parseTwoDigitYear(b)}}function S(a){var c,d,e,f,g,h,i;c=a._w,null!=c.GG||null!=c.W||null!=c.E?(g=1,h=4,d=b(c.GG,a._a[Ab],hb(tb(),1,4).year),e=b(c.W,1),f=b(c.E,1)):(g=a._locale._week.dow,h=a._locale._week.doy,d=b(c.gg,a._a[Ab],hb(tb(),g,h).year),e=b(c.w,1),null!=c.d?(f=c.d,g>f&&++e):f=null!=c.e?c.e+g:g),i=ib(d,e,f,h,g),a._a[Ab]=i.year,a._dayOfYear=i.dayOfYear}function T(a){var c,d,e,f,g=[];if(!a._d){for(e=V(a),a._w&&null==a._a[Cb]&&null==a._a[Bb]&&S(a),a._dayOfYear&&(f=b(a._a[Ab],e[Ab]),a._dayOfYear>D(f)&&(a._pf._overflowDayOfYear=!0),d=db(f,0,a._dayOfYear),a._a[Bb]=d.getUTCMonth(),a._a[Cb]=d.getUTCDate()),
c=0;3>c&&null==a._a[c];++c)a._a[c]=g[c]=e[c];for(;7>c;c++)a._a[c]=g[c]=null==a._a[c]?2===c?1:0:a._a[c];24===a._a[Db]&&0===a._a[Eb]&&0===a._a[Fb]&&0===a._a[Gb]&&(a._nextDay=!0,a._a[Db]=0),a._d=(a._useUTC?db:cb).apply(null,g),null!=a._tzm&&a._d.setUTCMinutes(a._d.getUTCMinutes()+a._tzm),a._nextDay&&(a._a[Db]=24)}}function U(a){var b;a._d||(b=y(a._i),a._a=[b.year,b.month,b.day||b.date,b.hour,b.minute,b.second,b.millisecond],T(a))}function V(a){var b=new Date;return a._useUTC?[b.getUTCFullYear(),b.getUTCMonth(),b.getUTCDate()]:[b.getFullYear(),b.getMonth(),b.getDate()]}function W(b){if(b._f===tb.ISO_8601)return void $(b);b._a=[],b._pf.empty=!0;var c,d,e,f,g,h=""+b._i,i=h.length,j=0;for(e=O(b._f,b._locale).match(Nb)||[],c=0;c<e.length;c++)f=e[c],d=(h.match(P(f,b))||[])[0],d&&(g=h.substr(0,h.indexOf(d)),g.length>0&&b._pf.unusedInput.push(g),h=h.slice(h.indexOf(d)+d.length),j+=d.length),pc[f]?(d?b._pf.empty=!1:b._pf.unusedTokens.push(f),R(f,d,b)):b._strict&&!d&&b._pf.unusedTokens.push(f);b._pf.charsLeftOver=i-j,h.length>0&&b._pf.unusedInput.push(h),b._pf.bigHour===!0&&b._a[Db]<=12&&(b._pf.bigHour=a),b._isPm&&b._a[Db]<12&&(b._a[Db]+=12),b._isPm===!1&&12===b._a[Db]&&(b._a[Db]=0),T(b),F(b)}function X(a){return a.replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(a,b,c,d,e){return b||c||d||e})}function Y(a){return a.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}function Z(a){var b,c,e,f,g;if(0===a._f.length)return a._pf.invalidFormat=!0,void(a._d=new Date(NaN));for(f=0;f<a._f.length;f++)g=0,b=n({},a),null!=a._useUTC&&(b._useUTC=a._useUTC),b._pf=d(),b._f=a._f[f],W(b),G(b)&&(g+=b._pf.charsLeftOver,g+=10*b._pf.unusedTokens.length,b._pf.score=g,(null==e||e>g)&&(e=g,c=b));m(a,c||b)}function $(a){var b,c,d=a._i,e=dc.exec(d);if(e){for(a._pf.iso=!0,b=0,c=fc.length;c>b;b++)if(fc[b][1].exec(d)){a._f=fc[b][0]+(e[6]||" ");break}for(b=0,c=gc.length;c>b;b++)if(gc[b][1].exec(d)){a._f+=gc[b][0];break}d.match(Vb)&&(a._f+="Z"),W(a)}else a._isValid=!1}function _(a){$(a),a._isValid===!1&&(delete a._isValid,tb.createFromInputFallback(a))}function ab(a,b){var c,d=[];for(c=0;c<a.length;++c)d.push(b(a[c],c));return d}function bb(b){var c,d=b._i;d===a?b._d=new Date:v(d)?b._d=new Date(+d):null!==(c=Kb.exec(d))?b._d=new Date(+c[1]):"string"==typeof d?_(b):u(d)?(b._a=ab(d.slice(0),function(a){return parseInt(a,10)}),T(b)):"object"==typeof d?U(b):"number"==typeof d?b._d=new Date(d):tb.createFromInputFallback(b)}function cb(a,b,c,d,e,f,g){var h=new Date(a,b,c,d,e,f,g);return 1970>a&&h.setFullYear(a),h}function db(a){var b=new Date(Date.UTC.apply(null,arguments));return 1970>a&&b.setUTCFullYear(a),b}function eb(a,b){if("string"==typeof a)if(isNaN(a)){if(a=b.weekdaysParse(a),"number"!=typeof a)return null}else a=parseInt(a,10);return a}function fb(a,b,c,d,e){return e.relativeTime(b||1,!!c,a,d)}function gb(a,b,c){var d=tb.duration(a).abs(),e=yb(d.as("s")),f=yb(d.as("m")),g=yb(d.as("h")),h=yb(d.as("d")),i=yb(d.as("M")),j=yb(d.as("y")),k=e<mc.s&&["s",e]||1===f&&["m"]||f<mc.m&&["mm",f]||1===g&&["h"]||g<mc.h&&["hh",g]||1===h&&["d"]||h<mc.d&&["dd",h]||1===i&&["M"]||i<mc.M&&["MM",i]||1===j&&["y"]||["yy",j];return k[2]=b,k[3]=+a>0,k[4]=c,fb.apply({},k)}function hb(a,b,c){var d,e=c-b,f=c-a.day();return f>e&&(f-=7),e-7>f&&(f+=7),d=tb(a).add(f,"d"),{week:Math.ceil(d.dayOfYear()/7),year:d.year()}}function ib(a,b,c,d,e){var f,g,h=db(a,0,1).getUTCDay();return h=0===h?7:h,c=null!=c?c:e,f=e-h+(h>d?7:0)-(e>h?7:0),g=7*(b-1)+(c-e)+f+1,{year:g>0?a:a-1,dayOfYear:g>0?g:D(a-1)+g}}function jb(b){var c,d=b._i,e=b._f;return b._locale=b._locale||tb.localeData(b._l),null===d||e===a&&""===d?tb.invalid({nullInput:!0}):("string"==typeof d&&(b._i=d=b._locale.preparse(d)),tb.isMoment(d)?new k(d,!0):(e?u(e)?Z(b):W(b):bb(b),c=new k(b),c._nextDay&&(c.add(1,"d"),c._nextDay=a),c))}function kb(a,b){var c,d;if(1===b.length&&u(b[0])&&(b=b[0]),!b.length)return tb();for(c=b[0],d=1;d<b.length;++d)b[d][a](c)&&(c=b[d]);return c}function lb(a,b){var c;return"string"==typeof b&&(b=a.localeData().monthsParse(b),"number"!=typeof b)?a:(c=Math.min(a.date(),B(a.year(),b)),a._d["set"+(a._isUTC?"UTC":"")+"Month"](b,c),a)}function mb(a,b){return a._d["get"+(a._isUTC?"UTC":"")+b]()}function nb(a,b,c){return"Month"===b?lb(a,c):a._d["set"+(a._isUTC?"UTC":"")+b](c)}function ob(a,b){return function(c){return null!=c?(nb(this,a,c),tb.updateOffset(this,b),this):mb(this,a)}}function pb(a){return 400*a/146097}function qb(a){return 146097*a/400}function rb(a){tb.duration.fn[a]=function(){return this._data[a]}}function sb(a){"undefined"==typeof ender&&(ub=xb.moment,xb.moment=a?f("Accessing Moment through the global scope is deprecated, and will be removed in an upcoming release.",tb):tb)}for(var tb,ub,vb,wb="2.8.4",xb="undefined"!=typeof global?global:this,yb=Math.round,zb=Object.prototype.hasOwnProperty,Ab=0,Bb=1,Cb=2,Db=3,Eb=4,Fb=5,Gb=6,Hb={},Ib=[],Jb="undefined"!=typeof module&&module&&module.exports,Kb=/^\/?Date\((\-?\d+)/i,Lb=/(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,Mb=/^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/,Nb=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,4}|x|X|zz?|ZZ?|.)/g,Ob=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,Pb=/\d\d?/,Qb=/\d{1,3}/,Rb=/\d{1,4}/,Sb=/[+\-]?\d{1,6}/,Tb=/\d+/,Ub=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,Vb=/Z|[\+\-]\d\d:?\d\d/gi,Wb=/T/i,Xb=/[\+\-]?\d+/,Yb=/[\+\-]?\d+(\.\d{1,3})?/,Zb=/\d/,$b=/\d\d/,_b=/\d{3}/,ac=/\d{4}/,bc=/[+-]?\d{6}/,cc=/[+-]?\d+/,dc=/^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,ec="YYYY-MM-DDTHH:mm:ssZ",fc=[["YYYYYY-MM-DD",/[+-]\d{6}-\d{2}-\d{2}/],["YYYY-MM-DD",/\d{4}-\d{2}-\d{2}/],["GGGG-[W]WW-E",/\d{4}-W\d{2}-\d/],["GGGG-[W]WW",/\d{4}-W\d{2}/],["YYYY-DDD",/\d{4}-\d{3}/]],gc=[["HH:mm:ss.SSSS",/(T| )\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss",/(T| )\d\d:\d\d:\d\d/],["HH:mm",/(T| )\d\d:\d\d/],["HH",/(T| )\d\d/]],hc=/([\+\-]|\d\d)/gi,ic=("Date|Hours|Minutes|Seconds|Milliseconds".split("|"),{Milliseconds:1,Seconds:1e3,Minutes:6e4,Hours:36e5,Days:864e5,Months:2592e6,Years:31536e6}),jc={ms:"millisecond",s:"second",m:"minute",h:"hour",d:"day",D:"date",w:"week",W:"isoWeek",M:"month",Q:"quarter",y:"year",DDD:"dayOfYear",e:"weekday",E:"isoWeekday",gg:"weekYear",GG:"isoWeekYear"},kc={dayofyear:"dayOfYear",isoweekday:"isoWeekday",isoweek:"isoWeek",weekyear:"weekYear",isoweekyear:"isoWeekYear"},lc={},mc={s:45,m:45,h:22,d:26,M:11},nc="DDD w W M D d".split(" "),oc="M D H h m s w W".split(" "),pc={M:function(){return this.month()+1},MMM:function(a){return this.localeData().monthsShort(this,a)},MMMM:function(a){return this.localeData().months(this,a)},D:function(){return this.date()},DDD:function(){return this.dayOfYear()},d:function(){return this.day()},dd:function(a){return this.localeData().weekdaysMin(this,a)},ddd:function(a){return this.localeData().weekdaysShort(this,a)},dddd:function(a){return this.localeData().weekdays(this,a)},w:function(){return this.week()},W:function(){return this.isoWeek()},YY:function(){return p(this.year()%100,2)},YYYY:function(){return p(this.year(),4)},YYYYY:function(){return p(this.year(),5)},YYYYYY:function(){var a=this.year(),b=a>=0?"+":"-";return b+p(Math.abs(a),6)},gg:function(){return p(this.weekYear()%100,2)},gggg:function(){return p(this.weekYear(),4)},ggggg:function(){return p(this.weekYear(),5)},GG:function(){return p(this.isoWeekYear()%100,2)},GGGG:function(){return p(this.isoWeekYear(),4)},GGGGG:function(){return p(this.isoWeekYear(),5)},e:function(){return this.weekday()},E:function(){return this.isoWeekday()},a:function(){return this.localeData().meridiem(this.hours(),this.minutes(),!0)},A:function(){return this.localeData().meridiem(this.hours(),this.minutes(),!1)},H:function(){return this.hours()},h:function(){return this.hours()%12||12},m:function(){return this.minutes()},s:function(){return this.seconds()},S:function(){return A(this.milliseconds()/100)},SS:function(){return p(A(this.milliseconds()/10),2)},SSS:function(){return p(this.milliseconds(),3)},SSSS:function(){return p(this.milliseconds(),3)},Z:function(){var a=-this.zone(),b="+";return 0>a&&(a=-a,b="-"),b+p(A(a/60),2)+":"+p(A(a)%60,2)},ZZ:function(){var a=-this.zone(),b="+";return 0>a&&(a=-a,b="-"),b+p(A(a/60),2)+p(A(a)%60,2)},z:function(){return this.zoneAbbr()},zz:function(){return this.zoneName()},x:function(){return this.valueOf()},X:function(){return this.unix()},Q:function(){return this.quarter()}},qc={},rc=["months","monthsShort","weekdays","weekdaysShort","weekdaysMin"];nc.length;)vb=nc.pop(),pc[vb+"o"]=i(pc[vb],vb);for(;oc.length;)vb=oc.pop(),pc[vb+vb]=h(pc[vb],2);pc.DDDD=h(pc.DDD,3),m(j.prototype,{set:function(a){var b,c;for(c in a)b=a[c],"function"==typeof b?this[c]=b:this["_"+c]=b;this._ordinalParseLenient=new RegExp(this._ordinalParse.source+"|"+/\d{1,2}/.source)},_months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),months:function(a){return this._months[a.month()]},_monthsShort:"Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),monthsShort:function(a){return this._monthsShort[a.month()]},monthsParse:function(a,b,c){var d,e,f;for(this._monthsParse||(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[]),d=0;12>d;d++){if(e=tb.utc([2e3,d]),c&&!this._longMonthsParse[d]&&(this._longMonthsParse[d]=new RegExp("^"+this.months(e,"").replace(".","")+"$","i"),this._shortMonthsParse[d]=new RegExp("^"+this.monthsShort(e,"").replace(".","")+"$","i")),c||this._monthsParse[d]||(f="^"+this.months(e,"")+"|^"+this.monthsShort(e,""),this._monthsParse[d]=new RegExp(f.replace(".",""),"i")),c&&"MMMM"===b&&this._longMonthsParse[d].test(a))return d;if(c&&"MMM"===b&&this._shortMonthsParse[d].test(a))return d;if(!c&&this._monthsParse[d].test(a))return d}},_weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),weekdays:function(a){return this._weekdays[a.day()]},_weekdaysShort:"Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),weekdaysShort:function(a){return this._weekdaysShort[a.day()]},_weekdaysMin:"Su_Mo_Tu_We_Th_Fr_Sa".split("_"),weekdaysMin:function(a){return this._weekdaysMin[a.day()]},weekdaysParse:function(a){var b,c,d;for(this._weekdaysParse||(this._weekdaysParse=[]),b=0;7>b;b++)if(this._weekdaysParse[b]||(c=tb([2e3,1]).day(b),d="^"+this.weekdays(c,"")+"|^"+this.weekdaysShort(c,"")+"|^"+this.weekdaysMin(c,""),this._weekdaysParse[b]=new RegExp(d.replace(".",""),"i")),this._weekdaysParse[b].test(a))return b},_longDateFormat:{LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY LT",LLLL:"dddd, MMMM D, YYYY LT"},longDateFormat:function(a){var b=this._longDateFormat[a];return!b&&this._longDateFormat[a.toUpperCase()]&&(b=this._longDateFormat[a.toUpperCase()].replace(/MMMM|MM|DD|dddd/g,function(a){return a.slice(1)}),this._longDateFormat[a]=b),b},isPM:function(a){return"p"===(a+"").toLowerCase().charAt(0)},_meridiemParse:/[ap]\.?m?\.?/i,meridiem:function(a,b,c){return a>11?c?"pm":"PM":c?"am":"AM"},_calendar:{sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},calendar:function(a,b,c){var d=this._calendar[a];return"function"==typeof d?d.apply(b,[c]):d},_relativeTime:{future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},relativeTime:function(a,b,c,d){var e=this._relativeTime[c];return"function"==typeof e?e(a,b,c,d):e.replace(/%d/i,a)},pastFuture:function(a,b){var c=this._relativeTime[a>0?"future":"past"];return"function"==typeof c?c(b):c.replace(/%s/i,b)},ordinal:function(a){return this._ordinal.replace("%d",a)},_ordinal:"%d",_ordinalParse:/\d{1,2}/,preparse:function(a){return a},postformat:function(a){return a},week:function(a){return hb(a,this._week.dow,this._week.doy).week},_week:{dow:0,doy:6},_invalidDate:"Invalid date",invalidDate:function(){return this._invalidDate}}),tb=function(b,c,e,f){var g;return"boolean"==typeof e&&(f=e,e=a),g={},g._isAMomentObject=!0,g._i=b,g._f=c,g._l=e,g._strict=f,g._isUTC=!1,g._pf=d(),jb(g)},tb.suppressDeprecationWarnings=!1,tb.createFromInputFallback=f("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to https://github.com/moment/moment/issues/1407 for more info.",function(a){a._d=new Date(a._i+(a._useUTC?" UTC":""))}),tb.min=function(){var a=[].slice.call(arguments,0);return kb("isBefore",a)},tb.max=function(){var a=[].slice.call(arguments,0);return kb("isAfter",a)},tb.utc=function(b,c,e,f){var g;return"boolean"==typeof e&&(f=e,e=a),g={},g._isAMomentObject=!0,g._useUTC=!0,g._isUTC=!0,g._l=e,g._i=b,g._f=c,g._strict=f,g._pf=d(),jb(g).utc()},tb.unix=function(a){return tb(1e3*a)},tb.duration=function(a,b){var d,e,f,g,h=a,i=null;return tb.isDuration(a)?h={ms:a._milliseconds,d:a._days,M:a._months}:"number"==typeof a?(h={},b?h[b]=a:h.milliseconds=a):(i=Lb.exec(a))?(d="-"===i[1]?-1:1,h={y:0,d:A(i[Cb])*d,h:A(i[Db])*d,m:A(i[Eb])*d,s:A(i[Fb])*d,ms:A(i[Gb])*d}):(i=Mb.exec(a))?(d="-"===i[1]?-1:1,f=function(a){var b=a&&parseFloat(a.replace(",","."));return(isNaN(b)?0:b)*d},h={y:f(i[2]),M:f(i[3]),d:f(i[4]),h:f(i[5]),m:f(i[6]),s:f(i[7]),w:f(i[8])}):"object"==typeof h&&("from"in h||"to"in h)&&(g=r(tb(h.from),tb(h.to)),h={},h.ms=g.milliseconds,h.M=g.months),e=new l(h),tb.isDuration(a)&&c(a,"_locale")&&(e._locale=a._locale),e},tb.version=wb,tb.defaultFormat=ec,tb.ISO_8601=function(){},tb.momentProperties=Ib,tb.updateOffset=function(){},tb.relativeTimeThreshold=function(b,c){return mc[b]===a?!1:c===a?mc[b]:(mc[b]=c,!0)},tb.lang=f("moment.lang is deprecated. Use moment.locale instead.",function(a,b){return tb.locale(a,b)}),tb.locale=function(a,b){var c;return a&&(c="undefined"!=typeof b?tb.defineLocale(a,b):tb.localeData(a),c&&(tb.duration._locale=tb._locale=c)),tb._locale._abbr},tb.defineLocale=function(a,b){return null!==b?(b.abbr=a,Hb[a]||(Hb[a]=new j),Hb[a].set(b),tb.locale(a),Hb[a]):(delete Hb[a],null)},tb.langData=f("moment.langData is deprecated. Use moment.localeData instead.",function(a){return tb.localeData(a)}),tb.localeData=function(a){var b;if(a&&a._locale&&a._locale._abbr&&(a=a._locale._abbr),!a)return tb._locale;if(!u(a)){if(b=J(a))return b;a=[a]}return I(a)},tb.isMoment=function(a){return a instanceof k||null!=a&&c(a,"_isAMomentObject")},tb.isDuration=function(a){return a instanceof l};for(vb=rc.length-1;vb>=0;--vb)z(rc[vb]);tb.normalizeUnits=function(a){return x(a)},tb.invalid=function(a){var b=tb.utc(NaN);return null!=a?m(b._pf,a):b._pf.userInvalidated=!0,b},tb.parseZone=function(){return tb.apply(null,arguments).parseZone()},tb.parseTwoDigitYear=function(a){return A(a)+(A(a)>68?1900:2e3)},m(tb.fn=k.prototype,{clone:function(){return tb(this)},valueOf:function(){return+this._d+6e4*(this._offset||0)},unix:function(){return Math.floor(+this/1e3)},toString:function(){return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")},toDate:function(){return this._offset?new Date(+this):this._d},toISOString:function(){var a=tb(this).utc();return 0<a.year()&&a.year()<=9999?"function"==typeof Date.prototype.toISOString?this.toDate().toISOString():N(a,"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]"):N(a,"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")},toArray:function(){var a=this;return[a.year(),a.month(),a.date(),a.hours(),a.minutes(),a.seconds(),a.milliseconds()]},isValid:function(){return G(this)},isDSTShifted:function(){return this._a?this.isValid()&&w(this._a,(this._isUTC?tb.utc(this._a):tb(this._a)).toArray())>0:!1},parsingFlags:function(){return m({},this._pf)},invalidAt:function(){return this._pf.overflow},utc:function(a){return this.zone(0,a)},local:function(a){return this._isUTC&&(this.zone(0,a),this._isUTC=!1,a&&this.add(this._dateTzOffset(),"m")),this},format:function(a){var b=N(this,a||tb.defaultFormat);return this.localeData().postformat(b)},add:s(1,"add"),subtract:s(-1,"subtract"),diff:function(a,b,c){var d,e,f,g=K(a,this),h=6e4*(this.zone()-g.zone());return b=x(b),"year"===b||"month"===b?(d=432e5*(this.daysInMonth()+g.daysInMonth()),e=12*(this.year()-g.year())+(this.month()-g.month()),f=this-tb(this).startOf("month")-(g-tb(g).startOf("month")),f-=6e4*(this.zone()-tb(this).startOf("month").zone()-(g.zone()-tb(g).startOf("month").zone())),e+=f/d,"year"===b&&(e/=12)):(d=this-g,e="second"===b?d/1e3:"minute"===b?d/6e4:"hour"===b?d/36e5:"day"===b?(d-h)/864e5:"week"===b?(d-h)/6048e5:d),c?e:o(e)},from:function(a,b){return tb.duration({to:this,from:a}).locale(this.locale()).humanize(!b)},fromNow:function(a){return this.from(tb(),a)},calendar:function(a){var b=a||tb(),c=K(b,this).startOf("day"),d=this.diff(c,"days",!0),e=-6>d?"sameElse":-1>d?"lastWeek":0>d?"lastDay":1>d?"sameDay":2>d?"nextDay":7>d?"nextWeek":"sameElse";return this.format(this.localeData().calendar(e,this,tb(b)))},isLeapYear:function(){return E(this.year())},isDST:function(){return this.zone()<this.clone().month(0).zone()||this.zone()<this.clone().month(5).zone()},day:function(a){var b=this._isUTC?this._d.getUTCDay():this._d.getDay();return null!=a?(a=eb(a,this.localeData()),this.add(a-b,"d")):b},month:ob("Month",!0),startOf:function(a){switch(a=x(a)){case"year":this.month(0);case"quarter":case"month":this.date(1);case"week":case"isoWeek":case"day":this.hours(0);case"hour":this.minutes(0);case"minute":this.seconds(0);case"second":this.milliseconds(0)}return"week"===a?this.weekday(0):"isoWeek"===a&&this.isoWeekday(1),"quarter"===a&&this.month(3*Math.floor(this.month()/3)),this},endOf:function(b){return b=x(b),b===a||"millisecond"===b?this:this.startOf(b).add(1,"isoWeek"===b?"week":b).subtract(1,"ms")},isAfter:function(a,b){var c;return b=x("undefined"!=typeof b?b:"millisecond"),"millisecond"===b?(a=tb.isMoment(a)?a:tb(a),+this>+a):(c=tb.isMoment(a)?+a:+tb(a),c<+this.clone().startOf(b))},isBefore:function(a,b){var c;return b=x("undefined"!=typeof b?b:"millisecond"),"millisecond"===b?(a=tb.isMoment(a)?a:tb(a),+a>+this):(c=tb.isMoment(a)?+a:+tb(a),+this.clone().endOf(b)<c)},isSame:function(a,b){var c;return b=x(b||"millisecond"),"millisecond"===b?(a=tb.isMoment(a)?a:tb(a),+this===+a):(c=+tb(a),+this.clone().startOf(b)<=c&&c<=+this.clone().endOf(b))},min:f("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(a){return a=tb.apply(null,arguments),this>a?this:a}),max:f("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",function(a){return a=tb.apply(null,arguments),a>this?this:a}),zone:function(a,b){var c,d=this._offset||0;return null==a?this._isUTC?d:this._dateTzOffset():("string"==typeof a&&(a=Q(a)),Math.abs(a)<16&&(a=60*a),!this._isUTC&&b&&(c=this._dateTzOffset()),this._offset=a,this._isUTC=!0,null!=c&&this.subtract(c,"m"),d!==a&&(!b||this._changeInProgress?t(this,tb.duration(d-a,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,tb.updateOffset(this,!0),this._changeInProgress=null)),this)},zoneAbbr:function(){return this._isUTC?"UTC":""},zoneName:function(){return this._isUTC?"Coordinated Universal Time":""},parseZone:function(){return this._tzm?this.zone(this._tzm):"string"==typeof this._i&&this.zone(this._i),this},hasAlignedHourOffset:function(a){return a=a?tb(a).zone():0,(this.zone()-a)%60===0},daysInMonth:function(){return B(this.year(),this.month())},dayOfYear:function(a){var b=yb((tb(this).startOf("day")-tb(this).startOf("year"))/864e5)+1;return null==a?b:this.add(a-b,"d")},quarter:function(a){return null==a?Math.ceil((this.month()+1)/3):this.month(3*(a-1)+this.month()%3)},weekYear:function(a){var b=hb(this,this.localeData()._week.dow,this.localeData()._week.doy).year;return null==a?b:this.add(a-b,"y")},isoWeekYear:function(a){var b=hb(this,1,4).year;return null==a?b:this.add(a-b,"y")},week:function(a){var b=this.localeData().week(this);return null==a?b:this.add(7*(a-b),"d")},isoWeek:function(a){var b=hb(this,1,4).week;return null==a?b:this.add(7*(a-b),"d")},weekday:function(a){var b=(this.day()+7-this.localeData()._week.dow)%7;return null==a?b:this.add(a-b,"d")},isoWeekday:function(a){return null==a?this.day()||7:this.day(this.day()%7?a:a-7)},isoWeeksInYear:function(){return C(this.year(),1,4)},weeksInYear:function(){var a=this.localeData()._week;return C(this.year(),a.dow,a.doy)},get:function(a){return a=x(a),this[a]()},set:function(a,b){return a=x(a),"function"==typeof this[a]&&this[a](b),this},locale:function(b){var c;return b===a?this._locale._abbr:(c=tb.localeData(b),null!=c&&(this._locale=c),this)},lang:f("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(b){return b===a?this.localeData():this.locale(b)}),localeData:function(){return this._locale},_dateTzOffset:function(){return 15*Math.round(this._d.getTimezoneOffset()/15)}}),tb.fn.millisecond=tb.fn.milliseconds=ob("Milliseconds",!1),tb.fn.second=tb.fn.seconds=ob("Seconds",!1),tb.fn.minute=tb.fn.minutes=ob("Minutes",!1),tb.fn.hour=tb.fn.hours=ob("Hours",!0),tb.fn.date=ob("Date",!0),tb.fn.dates=f("dates accessor is deprecated. Use date instead.",ob("Date",!0)),tb.fn.year=ob("FullYear",!0),tb.fn.years=f("years accessor is deprecated. Use year instead.",ob("FullYear",!0)),tb.fn.days=tb.fn.day,tb.fn.months=tb.fn.month,tb.fn.weeks=tb.fn.week,tb.fn.isoWeeks=tb.fn.isoWeek,tb.fn.quarters=tb.fn.quarter,tb.fn.toJSON=tb.fn.toISOString,m(tb.duration.fn=l.prototype,{_bubble:function(){var a,b,c,d=this._milliseconds,e=this._days,f=this._months,g=this._data,h=0;g.milliseconds=d%1e3,a=o(d/1e3),g.seconds=a%60,b=o(a/60),g.minutes=b%60,c=o(b/60),g.hours=c%24,e+=o(c/24),h=o(pb(e)),e-=o(qb(h)),f+=o(e/30),e%=30,h+=o(f/12),f%=12,g.days=e,g.months=f,g.years=h},abs:function(){return this._milliseconds=Math.abs(this._milliseconds),this._days=Math.abs(this._days),this._months=Math.abs(this._months),this._data.milliseconds=Math.abs(this._data.milliseconds),this._data.seconds=Math.abs(this._data.seconds),this._data.minutes=Math.abs(this._data.minutes),this._data.hours=Math.abs(this._data.hours),this._data.months=Math.abs(this._data.months),this._data.years=Math.abs(this._data.years),this},weeks:function(){return o(this.days()/7)},valueOf:function(){return this._milliseconds+864e5*this._days+this._months%12*2592e6+31536e6*A(this._months/12)},humanize:function(a){var b=gb(this,!a,this.localeData());return a&&(b=this.localeData().pastFuture(+this,b)),this.localeData().postformat(b)},add:function(a,b){var c=tb.duration(a,b);return this._milliseconds+=c._milliseconds,this._days+=c._days,this._months+=c._months,this._bubble(),this},subtract:function(a,b){var c=tb.duration(a,b);return this._milliseconds-=c._milliseconds,this._days-=c._days,this._months-=c._months,this._bubble(),this},get:function(a){return a=x(a),this[a.toLowerCase()+"s"]()},as:function(a){var b,c;if(a=x(a),"month"===a||"year"===a)return b=this._days+this._milliseconds/864e5,c=this._months+12*pb(b),"month"===a?c:c/12;switch(b=this._days+Math.round(qb(this._months/12)),a){case"week":return b/7+this._milliseconds/6048e5;case"day":return b+this._milliseconds/864e5;case"hour":return 24*b+this._milliseconds/36e5;case"minute":return 24*b*60+this._milliseconds/6e4;case"second":return 24*b*60*60+this._milliseconds/1e3;case"millisecond":return Math.floor(24*b*60*60*1e3)+this._milliseconds;default:throw new Error("Unknown unit "+a)}},lang:tb.fn.lang,locale:tb.fn.locale,toIsoString:f("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",function(){return this.toISOString()}),toISOString:function(){var a=Math.abs(this.years()),b=Math.abs(this.months()),c=Math.abs(this.days()),d=Math.abs(this.hours()),e=Math.abs(this.minutes()),f=Math.abs(this.seconds()+this.milliseconds()/1e3);return this.asSeconds()?(this.asSeconds()<0?"-":"")+"P"+(a?a+"Y":"")+(b?b+"M":"")+(c?c+"D":"")+(d||e||f?"T":"")+(d?d+"H":"")+(e?e+"M":"")+(f?f+"S":""):"P0D"},localeData:function(){return this._locale}}),tb.duration.fn.toString=tb.duration.fn.toISOString;for(vb in ic)c(ic,vb)&&rb(vb.toLowerCase());tb.duration.fn.asMilliseconds=function(){return this.as("ms")},tb.duration.fn.asSeconds=function(){return this.as("s")},tb.duration.fn.asMinutes=function(){return this.as("m")},tb.duration.fn.asHours=function(){return this.as("h")},tb.duration.fn.asDays=function(){return this.as("d")},tb.duration.fn.asWeeks=function(){return this.as("weeks")},tb.duration.fn.asMonths=function(){return this.as("M")},tb.duration.fn.asYears=function(){return this.as("y")},tb.locale("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(a){var b=a%10,c=1===A(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+c}}),Jb?module.exports=tb:"function"==typeof define&&define.amd?(define("moment",function(a,b,c){return c.config&&c.config()&&c.config().noGlobal===!0&&(xb.moment=ub),tb}),sb(!0)):sb()}.call(this),function(factory){"function"==typeof define&&define.amd?define(["jquery","moment"],factory):"object"==typeof exports?module.exports=factory(require("jquery"),require("moment")):factory(jQuery,moment)}(function($,moment){function mergeOptions(){var i,name,combinedVal,j,val,chain=Array.prototype.slice.call(arguments),complexVals={};for(i=0;i<complexOptions.length;i++){for(name=complexOptions[i],combinedVal=null,j=0;j<chain.length;j++)val=chain[j][name],$.isPlainObject(val)?combinedVal=$.extend(combinedVal||{},val):null!=val&&(combinedVal=null);null!==combinedVal&&(complexVals[name]=combinedVal)}return chain.unshift({}),chain.push(complexVals),$.extend.apply($,chain)}function massageOverrides(input){var subObj,overrides={views:input.views||{}};return $.each(input,function(name,val){"views"!=name&&($.isPlainObject(val)&&!/(time|duration|interval)$/i.test(name)&&-1==$.inArray(name,complexOptions)?(subObj=null,$.each(val,function(subName,subVal){/^(month|week|day|default|basic(Week|Day)?|agenda(Week|Day)?)$/.test(subName)?(overrides.views[subName]||(overrides.views[subName]={}),overrides.views[subName][name]=subVal):(subObj||(subObj={}),subObj[subName]=subVal)}),subObj&&(overrides[name]=subObj)):overrides[name]=val)}),overrides}function compensateScroll(rowEls,scrollbarWidths){scrollbarWidths.left&&rowEls.css({"border-left-width":1,"margin-left":scrollbarWidths.left-1}),scrollbarWidths.right&&rowEls.css({"border-right-width":1,"margin-right":scrollbarWidths.right-1})}function uncompensateScroll(rowEls){rowEls.css({"margin-left":"","margin-right":"","border-left-width":"","border-right-width":""})}function disableCursor(){$("body").addClass("fc-not-allowed")}function enableCursor(){$("body").removeClass("fc-not-allowed")}function distributeHeight(els,availableHeight,shouldRedistribute){var minOffset1=Math.floor(availableHeight/els.length),minOffset2=Math.floor(availableHeight-minOffset1*(els.length-1)),flexEls=[],flexOffsets=[],flexHeights=[],usedHeight=0;undistributeHeight(els),els.each(function(i,el){var minOffset=i===els.length-1?minOffset2:minOffset1,naturalOffset=$(el).outerHeight(!0);minOffset>naturalOffset?(flexEls.push(el),flexOffsets.push(naturalOffset),flexHeights.push($(el).height())):usedHeight+=naturalOffset}),shouldRedistribute&&(availableHeight-=usedHeight,minOffset1=Math.floor(availableHeight/flexEls.length),minOffset2=Math.floor(availableHeight-minOffset1*(flexEls.length-1))),$(flexEls).each(function(i,el){var minOffset=i===flexEls.length-1?minOffset2:minOffset1,naturalOffset=flexOffsets[i],naturalHeight=flexHeights[i],newHeight=minOffset-(naturalOffset-naturalHeight);minOffset>naturalOffset&&$(el).height(newHeight)})}function undistributeHeight(els){els.height("")}function matchCellWidths(els){var maxInnerWidth=0;return els.find("> *").each(function(i,innerEl){var innerWidth=$(innerEl).outerWidth();innerWidth>maxInnerWidth&&(maxInnerWidth=innerWidth)}),maxInnerWidth++,els.width(maxInnerWidth),maxInnerWidth}function setPotentialScroller(containerEl,height){return containerEl.height(height).addClass("fc-scroller"),containerEl[0].scrollHeight-1>containerEl[0].clientHeight?!0:(unsetScroller(containerEl),!1)}function unsetScroller(containerEl){containerEl.height("").removeClass("fc-scroller")}function getScrollParent(el){var position=el.css("position"),scrollParent=el.parents().filter(function(){var parent=$(this);return/(auto|scroll)/.test(parent.css("overflow")+parent.css("overflow-y")+parent.css("overflow-x"))}).eq(0);return"fixed"!==position&&scrollParent.length?scrollParent:$(el[0].ownerDocument||document)}function getOuterRect(el){var offset=el.offset();return{left:offset.left,right:offset.left+el.outerWidth(),top:offset.top,bottom:offset.top+el.outerHeight()}}function getClientRect(el){var offset=el.offset(),scrollbarWidths=getScrollbarWidths(el),left=offset.left+getCssFloat(el,"border-left-width")+scrollbarWidths.left,top=offset.top+getCssFloat(el,"border-top-width")+scrollbarWidths.top;return{left:left,right:left+el[0].clientWidth,top:top,bottom:top+el[0].clientHeight}}function getContentRect(el){var offset=el.offset(),left=offset.left+getCssFloat(el,"border-left-width")+getCssFloat(el,"padding-left"),top=offset.top+getCssFloat(el,"border-top-width")+getCssFloat(el,"padding-top");return{left:left,right:left+el.width(),top:top,bottom:top+el.height()}}function getScrollbarWidths(el){var leftRightWidth=el.innerWidth()-el[0].clientWidth,widths={left:0,right:0,top:0,bottom:el.innerHeight()-el[0].clientHeight};return getIsLeftRtlScrollbars()&&"rtl"==el.css("direction")?widths.left=leftRightWidth:widths.right=leftRightWidth,widths}function getIsLeftRtlScrollbars(){return null===_isLeftRtlScrollbars&&(_isLeftRtlScrollbars=computeIsLeftRtlScrollbars()),_isLeftRtlScrollbars}function computeIsLeftRtlScrollbars(){var el=$("<div><div/></div>").css({position:"absolute",top:-1e3,left:0,border:0,padding:0,overflow:"scroll",direction:"rtl"}).appendTo("body"),innerEl=el.children(),res=innerEl.offset().left>el.offset().left;return el.remove(),res}function getCssFloat(el,prop){return parseFloat(el.css(prop))||0}function isPrimaryMouseButton(ev){return 1==ev.which&&!ev.ctrlKey}function intersectRects(rect1,rect2){var res={left:Math.max(rect1.left,rect2.left),right:Math.min(rect1.right,rect2.right),top:Math.max(rect1.top,rect2.top),bottom:Math.min(rect1.bottom,rect2.bottom)};return res.left<res.right&&res.top<res.bottom?res:!1}function constrainPoint(point,rect){return{left:Math.min(Math.max(point.left,rect.left),rect.right),top:Math.min(Math.max(point.top,rect.top),rect.bottom)}}function getRectCenter(rect){return{left:(rect.left+rect.right)/2,top:(rect.top+rect.bottom)/2}}function diffPoints(point1,point2){return{left:point1.left-point2.left,top:point1.top-point2.top}}function intersectionToSeg(subjectRange,constraintRange){var segStart,segEnd,isStart,isEnd,subjectStart=subjectRange.start,subjectEnd=subjectRange.end,constraintStart=constraintRange.start,constraintEnd=constraintRange.end;return subjectEnd>constraintStart&&constraintEnd>subjectStart?(subjectStart>=constraintStart?(segStart=subjectStart.clone(),isStart=!0):(segStart=constraintStart.clone(),isStart=!1),constraintEnd>=subjectEnd?(segEnd=subjectEnd.clone(),isEnd=!0):(segEnd=constraintEnd.clone(),isEnd=!1),{start:segStart,end:segEnd,isStart:isStart,isEnd:isEnd}):void 0}function diffDayTime(a,b){return moment.duration({days:a.clone().stripTime().diff(b.clone().stripTime(),"days"),ms:a.time()-b.time()})}function diffDay(a,b){return moment.duration({days:a.clone().stripTime().diff(b.clone().stripTime(),"days")})}function diffByUnit(a,b,unit){return moment.duration(Math.round(a.diff(b,unit,!0)),unit)}function computeIntervalUnit(start,end){var i,unit,val;for(i=0;i<intervalUnits.length&&(unit=intervalUnits[i],val=computeRangeAs(unit,start,end),!(val>=1&&isInt(val)));i++);return unit}function computeRangeAs(unit,start,end){
